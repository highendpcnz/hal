...
var je = {
	...
	ceilPowerOfTwo: Ee,
	floorPowerOfTwo: De,
	setQuaternionFromProperEuler: Oe,
	normalize: Ae,
	denormalize: ke
}, U = class e {
	static {
	...
	*[Symbol.iterator]() {
	...
	applyEuler(e) {
		return this.applyQuaternion(Ne.setFromEuler(e));
	}
	applyAxisAngle(e, t) {
	...
	*[Symbol.iterator]() {
...
}, Me = /*@__PURE__*/ new G(), Ne = /*@__PURE__*/ new W(), K = class e {
	static {
	...
	scale(e, t) {
		return R("Matrix3: .scale() is deprecated. Use .makeScale() instead."), this.premultiply(q.makeScale(e, t)), this;
	}
	rotate(e) {
		return R("Matrix3: .rotate() is deprecated. Use .makeRotation() instead."), this.premultiply(q.makeRotation(-e)), this;
	}
	translate(e, t) {
		return R("Matrix3: .translate() is deprecated. Use .makeTranslation() instead."), this.premultiply(q.makeTranslation(e, t)), this;
	}
	makeTranslation(e, t) {
...
}, q = /*@__PURE__*/ new K(), Pe = /*@__PURE__*/ new K().set(.4123908, .3575843, .1804808, .212639, .7151687, .0721923, .0193308, .1191948, .9505322), J = /*@__PURE__*/ new K().set(3.2409699, -1.5373832, -.4986108, -.9692436, 1.8759675, .0415551, .0556301, -.203977, 1.0569715);
function Y() {
	let e = {
		enabled: !0,
		workingColorSpace: A,
...
var Le, Re = class {
	static getDataURL(e, t = "image/png") {
		...
		if (e instanceof HTMLCanvasElement) n = e;
			...
			Le === void 0 && (Le = ne("canvas")), Le.width = e.width, Le.height = e.height;
			let t = Le.getContext("2d");
			e instanceof ImageData ? t.putImageData(e, 0, 0) : t.drawImage(e, 0, 0, e.width, e.height), n = Le;
		}
	...
	static sRGBToLinear(e) {
		if (typeof HTMLImageElement < "u" && e instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && e instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && e instanceof ImageBitmap) {
			...
			for (let e = 0; e < i.length; e++) i[e] = Fe(i[e] / 255) * 255;
			return n.putImageData(r, 0, 0), t;
		} else if (e.data) {
			let t = e.data.slice(0);
			for (let e = 0; e < t.length; e++) t instanceof Uint8Array || t instanceof Uint8ClampedArray ? t[e] = Math.floor(Fe(t[e] / 255) * 255) : t[e] = Fe(t[e]);
			return {
				data: t,
				width: e.width,
				height: e.height
	...
	constructor(e = null) {
		this.isSource = !0, Object.defineProperty(this, "id", { value: ze++ }), this.uuid = V(), this.data = e, this.dataReady = !0, this.version = 0;
	}
	getSize(e) {
		let t = this.data;
	...
	toJSON(e) {
		...
		if (r !== null) {
			...
			if (Array.isArray(r)) {
				e = [];
				for (let t = 0, n = r.length; t < n; t++) r[t].isDataTexture ? e.push(Ve(r[t].image)) : e.push(Ve(r[t]));
			} else e = Ve(r);
			n.url = e;
		}
...
function Ve(e) {
	return typeof HTMLImageElement < "u" && e instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && e instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && e instanceof ImageBitmap ? Re.getDataURL(e) : e.data ? {
...
We.DEFAULT_IMAGE = null, We.DEFAULT_MAPPING = 300, We.DEFAULT_ANISOTROPY = 1;
var Ge = class e {
	static {
	...
	*[Symbol.iterator]() {
	...
	constructor(e = 1, t = 1, n = {}) {
		...
		}, n), this.isRenderTarget = !0, this.width = e, this.height = t, this.depth = n.depth, this.scissor = new Ge(0, 0, e, t), this.scissorTest = !1, this.viewport = new Ge(0, 0, e, t), this.textures = [];
		let r = new We({
			width: e,
			height: t,
			depth: n.depth
	...
	copy(e) {
		...
		for (let t = 0, n = e.textures.length; t < n; t++) {
			...
			this.textures[t].source = new Be(n);
		}
	...
	extractRotation(e) {
		...
		let t = this.elements, n = e.elements, r = 1 / Ze.setFromMatrixColumn(e, 0).length(), i = 1 / Ze.setFromMatrixColumn(e, 1).length(), a = 1 / Ze.setFromMatrixColumn(e, 2).length();
	...
	lookAt(e, t, n) {
		let r = this.elements;
		return rt.subVectors(e, t), rt.lengthSq() === 0 && (rt.z = 1), rt.normalize(), tt.crossVectors(n, rt), tt.lengthSq() === 0 && (Math.abs(n.z) === 1 ? rt.x += 1e-4 : rt.z += 1e-4, rt.normalize(), tt.crossVectors(n, rt)), tt.normalize(), nt.crossVectors(rt, tt), r[0] = tt.x, r[4] = nt.x, r[8] = rt.x, r[1] = tt.y, r[5] = nt.y, r[9] = rt.y, r[2] = tt.z, r[6] = nt.z, r[10] = rt.z, this;
	}
	multiply(e) {
		return this.multiplyMatrices(this, e);
	}
	...
	decompose(e, t, n) {
		...
		let a = Ze.set(r[0], r[1], r[2]).length(), o = Ze.set(r[4], r[5], r[6]).length(), s = Ze.set(r[8], r[9], r[10]).length();
		i < 0 && (a = -a), Qe.copy(this);
...
}, Ze = /*@__PURE__*/ new G(), Qe = /*@__PURE__*/ new Xe(), $e = /*@__PURE__*/ new G(0, 0, 0), et = /*@__PURE__*/ new G(1, 1, 1), tt = /*@__PURE__*/ new G(), nt = /*@__PURE__*/ new G(), rt = /*@__PURE__*/ new G(), it = /*@__PURE__*/ new Xe(), at = /*@__PURE__*/ new W(), ot = class e {
	...
	setFromQuaternion(e, t, n) {
		return it.makeRotationFromQuaternion(e), this.setFromRotationMatrix(it, t, n);
	}
...
var st = class {
...
}, ct = 0, lt = /*@__PURE__*/ new G(), ut = /*@__PURE__*/ new W(), dt = /*@__PURE__*/ new Xe(), ft = /*@__PURE__*/ new G(), pt = /*@__PURE__*/ new G(), mt = /*@__PURE__*/ new G(), ht = /*@__PURE__*/ new W(), gt = /*@__PURE__*/ new G(1, 0, 0), _t = /*@__PURE__*/ new G(0, 1, 0), vt = /*@__PURE__*/ new G(0, 0, 1), yt = { type: "added" }, bt = { type: "removed" }, xt = {
	type: "childadded",
	child: null
}, St = {
	type: "childremoved",
	child: null
}, Ct = class e extends z {
	constructor() {
		super(), this.isObject3D = !0, Object.defineProperty(this, "id", { value: ct++ }), this.uuid = V(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = e.DEFAULT_UP.clone();
		let t = new G(), n = new ot(), r = new W(), i = new G(1, 1, 1);
		function a() {
			r.setFromEuler(n, !1);
		}
		function o() {
		...
		}), this.matrix = new Xe(), this.matrixWorld = new Xe(), this.matrixAutoUpdate = e.DEFAULT_MATRIX_AUTO_UPDATE, this.matrixWorldAutoUpdate = e.DEFAULT_MATRIX_WORLD_AUTO_UPDATE, this.matrixWorldNeedsUpdate = !1, this.layers = new st(), this.visible = !0, this.castShadow = !1, this.receiveShadow = !1, this.frustumCulled = !0, this.renderOrder = 0, this.animations = [], this.customDepthMaterial = void 0, this.customDistanceMaterial = void 0, this.static = !1, this.userData = {}, this.pivot = null;
	}
	onBeforeShadow() {}
	onAfterShadow() {}
	onBeforeRender() {}
	...
	worldToLocal(e) {
		return this.updateWorldMatrix(!0, !1), e.applyMatrix4(dt.copy(this.matrixWorld).invert());
	}
	lookAt(e, t, n) {
		e.isVector3 ? ft.copy(e) : ft.set(e, t, n);
		let r = this.parent;
		this.updateWorldMatrix(!0, !1), pt.setFromMatrixPosition(this.matrixWorld), this.isCamera || this.isLight ? dt.lookAt(pt, ft, this.up) : dt.lookAt(ft, pt, this.up), this.quaternion.setFromRotationMatrix(dt), r && (dt.extractRotation(r.matrixWorld), ut.setFromRotationMatrix(dt), this.quaternion.premultiply(ut.invert()));
	}
	add(e) {
		...
		return e === this ? (L("Object3D.add: object can't be added as a child of itself.", e), this) : (e && e.isObject3D ? (e.removeFromParent(), e.parent = this, this.children.push(e), e.dispatchEvent(yt), xt.child = e, this.dispatchEvent(xt), xt.child = null) : L("Object3D.add: object not an instance of THREE.Object3D.", e), this);
	}
	remove(e) {
		if (arguments.length > 1) {
		...
		return t !== -1 && (e.parent = null, this.children.splice(t, 1), e.dispatchEvent(bt), St.child = e, this.dispatchEvent(St), St.child = null), this;
	}
	removeFromParent() {
		let e = this.parent;
	...
	getWorldQuaternion(e) {
		return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(pt, e, mt), e;
	}
	getWorldScale(e) {
		return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(pt, ht, e), e;
	}
	getWorldDirection(e) {
...
Ct.DEFAULT_UP = /*@__PURE__*/ new G(0, 1, 0), Ct.DEFAULT_MATRIX_AUTO_UPDATE = !0, Ct.DEFAULT_MATRIX_WORLD_AUTO_UPDATE = !0;
var wt = class extends Ct {
	constructor() {
		super(), this.isGroup = !0, this.type = "Group";
	}
}, Tt = { type: "move" }, Et = class {
	constructor() {
		this._targetRay = null, this._grip = null, this._hand = null;
	}
	getHandSpace() {
		return this._hand === null && (this._hand = new wt(), this._hand.matrixAutoUpdate = !1, this._hand.visible = !1, this._hand.joints = {}, this._hand.inputState = { pinching: !1 }), this._hand;
	}
	getTargetRaySpace() {
		return this._targetRay === null && (this._targetRay = new wt(), this._targetRay.matrixAutoUpdate = !1, this._targetRay.visible = !1, this._targetRay.hasLinearVelocity = !1, this._targetRay.linearVelocity = new G(), this._targetRay.hasAngularVelocity = !1, this._targetRay.angularVelocity = new G()), this._targetRay;
	}
	getGripSpace() {
		return this._grip === null && (this._grip = new wt(), this._grip.matrixAutoUpdate = !1, this._grip.visible = !1, this._grip.hasLinearVelocity = !1, this._grip.linearVelocity = new G(), this._grip.hasAngularVelocity = !1, this._grip.angularVelocity = new G(), this._grip.eventsEnabled = !1), this._grip;
	}
	dispatchEvent(e) {
...
var Z = class {
	...
	setHSL(e, t, n, r = X.workingColorSpace) {
		if (e = de(e, 1), t = H(t, 0, 1), n = H(n, 0, 1), t === 0) this.r = this.g = this.b = n;
			...
			this.r = At(i, r, e + 1 / 3), this.g = At(i, r, e), this.b = At(i, r, e - 1 / 3);
		}
	...
	getHex(e = k) {
		return X.workingToColorSpace(jt.copy(this), e), Math.round(H(jt.r * 255, 0, 255)) * 65536 + Math.round(H(jt.g * 255, 0, 255)) * 256 + Math.round(H(jt.b * 255, 0, 255));
	}
	getHexString(e = k) {
		return ("000000" + this.getHex(e).toString(16)).slice(-6);
	}
	getHSL(e, t = X.workingColorSpace) {
		X.workingToColorSpace(jt.copy(this), t);
	...
	getRGB(e, t = X.workingColorSpace) {
		return X.workingToColorSpace(jt.copy(this), t), e.r = jt.r, e.g = jt.g, e.b = jt.b, e;
	}
	getStyle(e = k) {
		X.workingToColorSpace(jt.copy(this), e);
	...
	offsetHSL(e, t, n) {
		return this.getHSL(Ot), this.setHSL(Ot.h + e, Ot.s + t, Ot.l + n);
	}
	add(e) {
		return this.r += e.r, this.g += e.g, this.b += e.b, this;
	}
	...
	lerpHSL(e, t) {
		this.getHSL(Ot), e.getHSL(kt);
		let n = me(Ot.h, kt.h, t), r = me(Ot.s, kt.s, t), i = me(Ot.l, kt.l, t);
...
var Mt = class e {
...
}, Pt = /*@__PURE__*/ new G(), Ft = /*@__PURE__*/ new G(), It = /*@__PURE__*/ new G(), Lt = /*@__PURE__*/ new G(), Rt = /*@__PURE__*/ new G(), zt = /*@__PURE__*/ new G(), Bt = /*@__PURE__*/ new G(), Vt = /*@__PURE__*/ new G(), Ht = /*@__PURE__*/ new G(), Ut = /*@__PURE__*/ new G(), Wt = /*@__PURE__*/ new Ge(), Gt = /*@__PURE__*/ new Ge(), Kt = /*@__PURE__*/ new Ge(), qt = class e {
	...
	/*@__PURE__*/ new G(),
	/*@__PURE__*/ new G()
], Xt = /*@__PURE__*/ new G(), Zt = /*@__PURE__*/ new Jt(), Qt = /*@__PURE__*/ new G(), $t = /*@__PURE__*/ new G(), en = /*@__PURE__*/ new G(), tn = /*@__PURE__*/ new G(), nn = /*@__PURE__*/ new G(), rn = /*@__PURE__*/ new G(), an = /*@__PURE__*/ new G(), on = /*@__PURE__*/ new G(), sn = /*@__PURE__*/ new G(), cn = /*@__PURE__*/ new G();
...
var un = /*@__PURE__*/ new G(), dn = /*@__PURE__*/ new U(), fn = 0, pn = class extends z {
	constructor(e, t, n = !1) {
	...
	setComponent(e, t, n) {
		return this.normalized && (n = Ae(n, this.array)), this.array[e * this.itemSize + t] = n, this;
	}
	getX(e) {
		let t = this.array[e * this.itemSize];
		return this.normalized && (t = ke(t, this.array)), t;
	}
	setX(e, t) {
		return this.normalized && (t = Ae(t, this.array)), this.array[e * this.itemSize] = t, this;
	}
	getY(e) {
	...
	setY(e, t) {
		return this.normalized && (t = Ae(t, this.array)), this.array[e * this.itemSize + 1] = t, this;
	}
	getZ(e) {
	...
	setZ(e, t) {
		return this.normalized && (t = Ae(t, this.array)), this.array[e * this.itemSize + 2] = t, this;
	}
	getW(e) {
	...
	setW(e, t) {
		return this.normalized && (t = Ae(t, this.array)), this.array[e * this.itemSize + 3] = t, this;
	}
	setXY(e, t, n) {
		return e *= this.itemSize, this.normalized && (t = Ae(t, this.array), n = Ae(n, this.array)), this.array[e + 0] = t, this.array[e + 1] = n, this;
	}
	setXYZ(e, t, n, r) {
		return e *= this.itemSize, this.normalized && (t = Ae(t, this.array), n = Ae(n, this.array), r = Ae(r, this.array)), this.array[e + 0] = t, this.array[e + 1] = n, this.array[e + 2] = r, this;
	}
	setXYZW(e, t, n, r, i) {
		return e *= this.itemSize, this.normalized && (t = Ae(t, this.array), n = Ae(n, this.array), r = Ae(r, this.array), i = Ae(i, this.array)), this.array[e + 0] = t, this.array[e + 1] = n, this.array[e + 2] = r, this.array[e + 3] = i, this;
	}
	onUpload(e) {
...
}, _n = /*@__PURE__*/ new Jt(), vn = /*@__PURE__*/ new G(), yn = /*@__PURE__*/ new G(), bn = class {
...
}, xn = 0, Sn = /*@__PURE__*/ new Xe(), Cn = /*@__PURE__*/ new Ct(), wn = /*@__PURE__*/ new G(), Tn = /*@__PURE__*/ new Jt(), En = /*@__PURE__*/ new Jt(), Dn = /*@__PURE__*/ new G(), On = class e extends z {
	constructor() {
		super(), this.isBufferGeometry = !0, Object.defineProperty(this, "id", { value: xn++ }), this.uuid = V(), this.name = "", this.type = "BufferGeometry", this.index = null, this.indirect = null, this.indirectOffset = 0, this.attributes = {}, this.morphAttributes = {}, this.morphTargetsRelative = !1, this.groups = [], this.boundingBox = null, this.boundingSphere = null, this.drawRange = {
			start: 0,
			count: Infinity
	...
	setIndex(e) {
		return Array.isArray(e) ? this.index = new (te(e) ? hn : mn)(e, 1) : this.index = e, this;
	}
	setIndirect(e, t = 0) {
	...
	computeBoundingBox() {
		...
		if (e && e.isGLBufferAttribute) {
			L("BufferGeometry.computeBoundingBox(): GLBufferAttribute requires a manual bounding box.", this), this.boundingBox.set(new G(-Infinity, -Infinity, -Infinity), new G(Infinity, Infinity, Infinity));
			return;
		}
		if (e !== void 0) {
	...
	computeBoundingSphere() {
		...
		let e = this.attributes.position, t = this.morphAttributes.position;
		if (e && e.isGLBufferAttribute) {
			L("BufferGeometry.computeBoundingSphere(): GLBufferAttribute requires a manual bounding sphere.", this), this.boundingSphere.set(new G(), Infinity);
			return;
		}
		if (e) {
	...
	computeTangents() {
		...
		let c = new G(), l = new G(), u = new G(), d = new U(), f = new U(), p = new U(), m = new G(), h = new G();
		function g(e, t, r) {
...
}, kn = 0, An = class extends z {
	constructor() {
		super(), this.isMaterial = !0, Object.defineProperty(this, "id", { value: kn++ }), this.uuid = V(), this.name = "", this.type = "Material", this.blending = 1, this.side = 0, this.vertexColors = !1, this.opacity = 1, this.transparent = !1, this.alphaHash = !1, this.blendSrc = 204, this.blendDst = 205, this.blendEquation = 100, this.blendSrcAlpha = null, this.blendDstAlpha = null, this.blendEquationAlpha = null, this.blendColor = new Z(0, 0, 0), this.blendAlpha = 0, this.depthFunc = 3, this.depthTest = !0, this.depthWrite = !0, this.stencilWriteMask = 255, this.stencilFunc = 519, this.stencilRef = 0, this.stencilFuncMask = 255, this.stencilFail = N, this.stencilZFail = N, this.stencilZPass = N, this.stencilWrite = !1, this.clippingPlanes = null, this.clipIntersection = !1, this.clipShadows = !1, this.shadowSide = null, this.colorWrite = !0, this.precision = null, this.polygonOffset = !1, this.polygonOffsetFactor = 0, this.polygonOffsetUnits = 0, this.dithering = !1, this.alphaToCoverage = !1, this.premultipliedAlpha = !1, this.forceSinglePass = !1, this.allowOverride = !0, this.visible = !0, this.toneMapped = !0, this.userData = {}, this.version = 0, this._alphaTest = 0;
	}
	get alphaTest() {
...
}, jn = /*@__PURE__*/ new G(), Mn = /*@__PURE__*/ new G(), Nn = /*@__PURE__*/ new G(), Pn = /*@__PURE__*/ new G(), Fn = /*@__PURE__*/ new G(), In = /*@__PURE__*/ new G(), Ln = /*@__PURE__*/ new G(), Rn = class {
...
}, Bn = /*@__PURE__*/ new Xe(), Vn = /*@__PURE__*/ new Rn(), Hn = /*@__PURE__*/ new bn(), Un = /*@__PURE__*/ new G(), Wn = /*@__PURE__*/ new G(), Gn = /*@__PURE__*/ new G(), Kn = /*@__PURE__*/ new G(), qn = /*@__PURE__*/ new G(), Jn = /*@__PURE__*/ new G(), Yn = /*@__PURE__*/ new G(), Xn = /*@__PURE__*/ new G(), Zn = class extends Ct {
	...
	_computeIntersections(e, t, n) {
		...
		if (o !== null) if (Array.isArray(a)) for (let i = 0, s = d.length; i < s; i++) {
			...
			for (let i = m, a = h; i < a; i += 3) {
				...
				r = $n(this, p, e, n, c, l, u, a, d, f), r && (r.faceIndex = Math.floor(i / 3), r.face.materialIndex = s.materialIndex, t.push(r));
			}
		}
		else {
			...
			for (let d = i, f = s; d < f; d += 3) {
				...
				r = $n(this, a, e, n, c, l, u, i, s, f), r && (r.faceIndex = Math.floor(d / 3), t.push(r));
			}
		}
			...
			for (let i = m, a = h; i < a; i += 3) {
				let a = i, s = i + 1, d = i + 2;
				r = $n(this, p, e, n, c, l, u, a, s, d), r && (r.faceIndex = Math.floor(i / 3), r.face.materialIndex = o.materialIndex, t.push(r));
			}
		}
		else {
			...
			for (let s = i, d = o; s < d; s += 3) {
				let i = s, o = s + 1, d = s + 2;
				r = $n(this, a, e, n, c, l, u, i, o, d), r && (r.faceIndex = Math.floor(s / 3), t.push(r));
			}
		}
	}
};
...
function $n(e, t, n, r, i, a, o, s, c, l) {
	...
	let u = Qn(e, t, n, r, Wn, Gn, Kn, Yn);
	if (u) {
		let e = new G();
		qt.getBarycoord(Yn, Wn, Gn, Kn, e), i && (u.uv = qt.getInterpolatedAttribute(i, s, c, l, e, new U())), a && (u.uv1 = qt.getInterpolatedAttribute(a, s, c, l, e, new U())), o && (u.normal = qt.getInterpolatedAttribute(o, s, c, l, e, new G()), u.normal.dot(r.direction) > 0 && u.normal.multiplyScalar(-1));
		let t = {
			a: s,
			b: c,
			c: l,
...
var er = class extends We {
...
}, nr = /*@__PURE__*/ new Xe(), rr = /*@__PURE__*/ new Xe(), ir = [], ar = /*@__PURE__*/ new Jt(), or = /*@__PURE__*/ new Xe(), sr = /*@__PURE__*/ new Zn(), cr = /*@__PURE__*/ new bn(), lr = class extends Zn {
	constructor(e, t, n) {
		...
		for (let e = 0; e < n; e++) this.setMatrixAt(e, or);
	}
	computeBoundingBox() {
		let e = this.geometry, t = this.count;
		this.boundingBox === null && (this.boundingBox = new Jt()), e.boundingBox === null && e.computeBoundingBox(), this.boundingBox.makeEmpty();
		for (let n = 0; n < t; n++) this.getMatrixAt(n, nr), ar.copy(e.boundingBox).applyMatrix4(nr), this.boundingBox.union(ar);
	}
	computeBoundingSphere() {
		let e = this.geometry, t = this.count;
		...
		for (let n = 0; n < t; n++) this.getMatrixAt(n, nr), cr.copy(e.boundingSphere).applyMatrix4(nr), this.boundingSphere.union(cr);
	}
	copy(e, t) {
	...
	raycast(e, t) {
		...
		if (sr.geometry = this.geometry, sr.material = this.material, sr.material !== void 0 && (this.boundingSphere === null && this.computeBoundingSphere(), cr.copy(this.boundingSphere), cr.applyMatrix4(n), e.ray.intersectsSphere(cr) !== !1)) for (let i = 0; i < r; i++) {
			this.getMatrixAt(i, nr), rr.multiplyMatrices(n, nr), sr.matrixWorld = rr, sr.raycast(e, ir);
			for (let e = 0, n = ir.length; e < n; e++) {
				let n = ir[e];
	...
	setMorphAt(e, t) {
		...
		this.morphTexture === null && (this.morphTexture = new er(new Float32Array(r * this.count), r, this.count, _, l));
...
}, ur = /*@__PURE__*/ new G(), dr = /*@__PURE__*/ new G(), fr = /*@__PURE__*/ new K(), pr = class {
	...
	setFromCoplanarPoints(e, t, n) {
		let r = ur.subVectors(n, t).cross(dr.subVectors(e, t)).normalize();
	...
	intersectLine(e, t, n = !0) {
		let r = e.delta(ur), i = this.normal.dot(r);
	...
	applyMatrix4(e, t) {
		let n = t || fr.getNormalMatrix(e), r = this.coplanarPoint(ur).applyMatrix4(e), i = this.normal.applyMatrix3(n).normalize();
...
}, mr = /*@__PURE__*/ new bn(), hr = /*@__PURE__*/ new U(.5, .5), gr = /*@__PURE__*/ new G(), _r = class {
	constructor(e = new pr(), t = new pr(), n = new pr(), r = new pr(), i = new pr(), a = new pr()) {
		this.planes = [
			e,
			t,
			n,
	...
	copy(e) {
		return super.copy(e), this.source = new Be(Object.assign({}, e.image)), this.compareFunction = e.compareFunction, this;
	}
	toJSON(e) {
		let t = super.toJSON(e);
	...
	constructor(e = 1, t = 32, n = 0, r = Math.PI * 2) {
		...
		this.setIndex(i), this.setAttribute("position", new gn(a, 3)), this.setAttribute("normal", new gn(o, 3)), this.setAttribute("uv", new gn(s, 2));
	}
	copy(e) {
		return super.copy(e), this.parameters = Object.assign({}, e.parameters), this;
	}
	...
	constructor(e = 1, t = 1, n = 1, r = 32, i = 1, a = !1, o = 0, s = Math.PI * 2) {
		...
		function v(n) {
			let i = p, a = new U(), m = new G(), _ = 0, v = n === !0 ? e : t, y = n === !0 ? 1 : -1;
...
function Or(e) {
	...
	for (let n in e) {
		...
		for (let r in e[n]) {
			let i = e[n][r];
			if (Ar(i)) i.isRenderTargetTexture ? (I("UniformsUtils: Textures of render targets cannot be cloned via cloneUniforms() or mergeUniforms()."), t[n][r] = null) : t[n][r] = i.clone();
			else if (Array.isArray(i)) if (Ar(i[0])) {
				let e = [];
...
var Nr = {
	...
	constructor(e) {
		super(), this.isShaderMaterial = !0, this.type = "ShaderMaterial", this.defines = {}, this.uniforms = {}, this.uniformsGroups = [], this.vertexShader = Pr, this.fragmentShader = Fr, this.linewidth = 1, this.wireframe = !1, this.wireframeLinewidth = 1, this.fog = !1, this.lights = !1, this.clipping = !1, this.forceSinglePass = !0, this.extensions = {
			clipCullDistance: !1,
			multiDraw: !1
...
var Ur = class {
	...
	constructor(e, t, n, r) {
		...
		this.name = e, this.times = Hr(t, this.TimeBufferType), this.values = Hr(n, this.ValueBufferType), this.setInterpolation(r || this.DefaultInterpolation);
	}
	static toJSON(e) {
	...
	InterpolantFactoryMethodBezier(e) {
		let t = new qr(this.times, this.values, this.getValueSize(), e);
...
Jr.prototype.ValueTypeName = "", Jr.prototype.TimeBufferType = Float32Array, Jr.prototype.ValueBufferType = Float32Array, Jr.prototype.DefaultInterpolation = C;
var Yr = class extends Jr {
	constructor(e, t, n) {
		super(e, t, n);
	}
};
Yr.prototype.ValueTypeName = "bool", Yr.prototype.ValueBufferType = Array, Yr.prototype.DefaultInterpolation = S, Yr.prototype.InterpolantFactoryMethodLinear = void 0, Yr.prototype.InterpolantFactoryMethodSmooth = void 0;
var Xr = class extends Jr {
	constructor(e, t, n, r) {
		super(e, t, n, r);
	}
};
Xr.prototype.ValueTypeName = "color";
var Zr = class extends Jr {
	constructor(e, t, n, r) {
		super(e, t, n, r);
	}
};
Zr.prototype.ValueTypeName = "number";
var Qr = class extends Ur {
	...
	interpolate_(e, t, n, r) {
		...
		for (let e = c + o; c !== e; c += 4) W.slerpFlat(i, 0, a, c - o, a, c, s);
		return i;
	}
}, $r = class extends Jr {
	constructor(e, t, n, r) {
...
$r.prototype.ValueTypeName = "quaternion", $r.prototype.InterpolantFactoryMethodSmooth = void 0;
var ei = class extends Jr {
	constructor(e, t, n) {
		super(e, t, n);
	}
};
ei.prototype.ValueTypeName = "string", ei.prototype.ValueBufferType = Array, ei.prototype.DefaultInterpolation = S, ei.prototype.InterpolantFactoryMethodLinear = void 0, ei.prototype.InterpolantFactoryMethodSmooth = void 0;
var ti = class extends Jr {
	constructor(e, t, n, r) {
		super(e, t, n, r);
	}
};
ti.prototype.ValueTypeName = "vector";
var ni = /*@__PURE__*/ new class {
	constructor(e, t, n) {
	...
	constructor(e) {
		this.manager = e === void 0 ? ni : e, this.crossOrigin = "anonymous", this.withCredentials = !1, this.path = "", this.resourcePath = "", this.requestHeader = {}, typeof __THREE_DEVTOOLS__ < "u" && __THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe", { detail: this }));
	}
	load() {}
	loadAsync(e, t) {
		let n = this;
...
var ii = class extends Ct {
...
}, ai = /*@__PURE__*/ new Xe(), oi = /*@__PURE__*/ new G(), si = /*@__PURE__*/ new G(), ci = class {
	constructor(e) {
		this.camera = e, this.intensity = 1, this.bias = 0, this.biasNode = null, this.normalBias = 0, this.radius = 1, this.blurSamples = 8, this.mapSize = new U(512, 512), this.mapType = o, this.map = null, this.mapPass = null, this.matrix = new Xe(), this.autoUpdate = !0, this.needsUpdate = !1, this._frustum = new _r(), this._frameExtents = new U(1, 1), this._viewportCount = 1, this._viewports = [new Ge(0, 0, 1, 1)];
	}
	getViewportCount() {
	...
	updateMatrices(e) {
		...
		oi.setFromMatrixPosition(e.matrixWorld), t.position.copy(oi), si.setFromMatrixPosition(e.target.matrixWorld), t.lookAt(si), t.updateMatrixWorld(), ai.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), this._frustum.setFromProjectionMatrix(ai, t.coordinateSystem, t.reversedDepth), t.coordinateSystem === 2001 || t.reversedDepth ? n.set(.5, 0, 0, .5, 0, .5, 0, .5, 0, 0, 1, 0, 0, 0, 0, 1) : n.set(.5, 0, 0, .5, 0, .5, 0, .5, 0, 0, .5, .5, 0, 0, 0, 1), n.multiply(ai);
	}
	getViewport(e) {
...
}, li = /*@__PURE__*/ new G(), ui = /*@__PURE__*/ new W(), di = /*@__PURE__*/ new G(), fi = class extends Ct {
	constructor() {
		super(), this.isCamera = !0, this.type = "Camera", this.matrixWorldInverse = new Xe(), this.projectionMatrix = new Xe(), this.projectionMatrixInverse = new Xe(), this.coordinateSystem = ee, this._reversedDepth = !1;
	}
	get reversedDepth() {
	...
	updateMatrixWorld(e) {
		super.updateMatrixWorld(e), this.matrixWorld.decompose(li, ui, di), di.x === 1 && di.y === 1 && di.z === 1 ? this.matrixWorldInverse.copy(this.matrixWorld).invert() : this.matrixWorldInverse.compose(li, ui, di.set(1, 1, 1)).invert();
	}
	updateWorldMatrix(e, t, n = !1) {
		super.updateWorldMatrix(e, t, n), this.matrixWorld.decompose(li, ui, di), di.x === 1 && di.y === 1 && di.z === 1 ? this.matrixWorldInverse.copy(this.matrixWorld).invert() : this.matrixWorldInverse.compose(li, ui, di.set(1, 1, 1)).invert();
	}
	clone() {
		return new this.constructor().copy(this);
	}
}, pi = /*@__PURE__*/ new G(), mi = /*@__PURE__*/ new U(), hi = /*@__PURE__*/ new U(), gi = class extends fi {
	...
	getViewBounds(e, t, n) {
		pi.set(-1, -1, .5).applyMatrix4(this.projectionMatrixInverse), t.set(pi.x, pi.y).multiplyScalar(-e / pi.z), pi.set(1, 1, .5).applyMatrix4(this.projectionMatrixInverse), n.set(pi.x, pi.y).multiplyScalar(-e / pi.z);
	}
	getViewSize(e, t) {
		return this.getViewBounds(e, mi, hi), t.subVectors(hi, mi);
	}
	...
	constructor() {
		super(new gi(90, 1, .5, 500)), this.isPointLightShadow = !0;
	}
}, vi = class extends ii {
	constructor(e, t, n = 0, r = 2) {
		super(e, t), this.isPointLight = !0, this.type = "PointLight", this.distance = n, this.decay = r, this.shadow = new _i();
	}
	get power() {
	...
	constructor(e, t) {
		super(e, t), this.isDirectionalLight = !0, this.type = "DirectionalLight", this.position.copy(Ct.DEFAULT_UP), this.updateMatrix(), this.target = new Ct(), this.shadow = new bi();
	}
	dispose() {
		super.dispose(), this.shadow.dispose();
	}
...
}, Ci = -90, wi = 1, Ti = class extends Ct {
	constructor(e, t, n) {
		super(), this.type = "CubeCamera", this.renderTarget = n, this.coordinateSystem = null, this.activeMipmapLevel = 0;
		let r = new gi(Ci, wi, e, t);
		r.layers = this.layers, this.add(r);
		let i = new gi(Ci, wi, e, t);
		i.layers = this.layers, this.add(i);
		let a = new gi(Ci, wi, e, t);
		a.layers = this.layers, this.add(a);
		let o = new gi(Ci, wi, e, t);
		o.layers = this.layers, this.add(o);
		let s = new gi(Ci, wi, e, t);
		s.layers = this.layers, this.add(s);
		let c = new gi(Ci, wi, e, t);
	...
	connect(e) {
		this._document = e, e.hidden !== void 0 && (this._pageVisibilityHandler = Oi.bind(this), e.addEventListener("visibilitychange", this._pageVisibilityHandler, !1));
	}
	disconnect() {
...
var ki = "\\[\\]\\.:\\/", Ai = /* @__PURE__ */ RegExp("[\\[\\]\\.:\\/]", "g"), ji = "[^\\[\\]\\.:\\/]", Mi = "[^" + ki.replace("\\.", "") + "]", Ni = /*@__PURE__*/ "((?:WC+[\\/:])*)".replace("WC", ji), Pi = /*@__PURE__*/ "(WCOD+)?".replace("WCOD", Mi), Fi = /*@__PURE__*/ "(?:\\.(WC+)(?:\\[(.+)\\])?)?".replace("WC", ji), Ii = /*@__PURE__*/ "\\.(WC+)(?:\\[(.+)\\])?".replace("WC", ji), Li = RegExp("^" + Ni + Pi + Fi + Ii + "$"), Ri = [
	"material",
	"materials",
	"bones",
	"map"
	...
	static sanitizeNodeName(e) {
		return e.replace(/\s/g, "_").replace(Ai, "");
	}
	static parseTrackName(e) {
		...
		if (r !== void 0 && r !== -1) {
			...
			Ri.indexOf(e) !== -1 && (n.nodeName = n.nodeName.substring(0, r), n.objectName = e);
		}
...
Bi.Composite = zi, Bi.prototype.BindingType = {
	Direct: 0,
	EntireArray: 1,
	ArrayElement: 2,
	HasFromToArray: 3
}, Bi.prototype.Versioning = {
	None: 0,
	NeedsUpdate: 1,
	MatrixWorldNeedsUpdate: 2
}, Bi.prototype.GetterByBindingType = [
	Bi.prototype._getValue_direct,
	Bi.prototype._getValue_array,
	Bi.prototype._getValue_arrayElement,
	Bi.prototype._getValue_toArray
], Bi.prototype.SetterByBindingTypeAndVersioning = [
	[
		Bi.prototype._setValue_direct,
		Bi.prototype._setValue_direct_setNeedsUpdate,
		Bi.prototype._setValue_direct_setMatrixWorldNeedsUpdate
	],
	[
		Bi.prototype._setValue_array,
		Bi.prototype._setValue_array_setNeedsUpdate,
		Bi.prototype._setValue_array_setMatrixWorldNeedsUpdate
	],
	[
		Bi.prototype._setValue_arrayElement,
		Bi.prototype._setValue_arrayElement_setNeedsUpdate,
		Bi.prototype._setValue_arrayElement_setMatrixWorldNeedsUpdate
	],
	[
		Bi.prototype._setValue_fromArray,
		Bi.prototype._setValue_fromArray_setNeedsUpdate,
		Bi.prototype._setValue_fromArray_setMatrixWorldNeedsUpdate
	]
], class e {
	static {
...
var Q = {
	...
	points: {
		uniforms: /*@__PURE__*/ kr([$.points, $.fog]),
	...
	depth: {
		uniforms: /*@__PURE__*/ kr([$.common, $.displacementmap]),
	...
	sprite: {
		uniforms: /*@__PURE__*/ kr([$.sprite, $.fog]),
...
Gi.physical = {
	uniforms: /*@__PURE__*/ kr([Gi.standard.uniforms, {
		clearcoat: { value: 0 },
...
var Ki = {
	...
	b: 0,
	g: 0
}, qi = /*@__PURE__*/ new Xe(), Ji = /*@__PURE__*/ new K();
...
function Yi(e, t, n, r, i, a) {
	...
	function h(t, n) {
		let i = p(n);
		i && (i.isCubeTexture || i.mapping === 306) ? (l === void 0 && (l = new Zn(new Sr(1, 1, 1), new Ir({
			name: "BackgroundCubeMaterial",
			uniforms: Or(Gi.backgroundCube.uniforms),
		...
		} }), r.update(l)), l.material.uniforms.envMap.value = i, l.material.uniforms.backgroundBlurriness.value = n.backgroundBlurriness, l.material.uniforms.backgroundIntensity.value = n.backgroundIntensity, l.material.uniforms.backgroundRotation.value.setFromMatrix4(qi.makeRotationFromEuler(n.backgroundRotation)).transpose(), i.isCubeTexture && i.isRenderTargetTexture === !1 && l.material.uniforms.backgroundRotation.value.premultiply(Ji), l.material.toneMapped = X.getTransfer(i.colorSpace) !== M, (u !== i || d !== i.version || f !== e.toneMapping) && (l.material.needsUpdate = !0, u = i, d = i.version, f = e.toneMapping), l.layers.enableAll(), t.unshift(l, l.geometry, l.material, 0, 0, null)) : i && i.isTexture && (c === void 0 && (c = new Zn(new Tr(2, 2), new Ir({
			name: "BackgroundMaterial",
			uniforms: Or(Gi.background.uniforms),
	...
	function g(t, r) {
		t.getRGB(Ki, Mr(e)), n.buffers.color.setClear(Ki.r, Ki.g, Ki.b, r, a);
	}
	function _() {
...
function $i(e) {
	let t = this, n = null, r = 0, i = !1, a = !1, o = new pr(), s = new K(), c = {
		value: null,
		needsUpdate: !1
	};
...
var ea = 4, ta = [
	...
	.526,
	.582
], na = 20, ra = 256, ia = /*@__PURE__*/ new yi(), aa = /*@__PURE__*/ new Z(), oa = null, sa = 0, ca = 0, la = !1, ua = /*@__PURE__*/ new G(), da = class {
	constructor(e) {
		this._renderer = e, this._pingPongRenderTarget = null, this._lodMax = 0, this._cubeSize = 0, this._sizeLods = [], this._sigmas = [], this._lodMeshes = [], this._backgroundBox = null, this._cubemapMaterial = null, this._equirectMaterial = null, this._blurMaterial = null, this._ggxMaterial = null;
	}
	fromScene(e, t = 0, n = .1, r = 100, i = {}) {
		let { size: a = 256, position: o = ua } = i;
		oa = this._renderer.getRenderTarget(), sa = this._renderer.getActiveCubeFace(), ca = this._renderer.getActiveMipmapLevel(), la = this._renderer.xr.enabled, this._renderer.xr.enabled = !1, this._setSize(a);
	...
	compileEquirectangularShader() {
		this._equirectMaterial === null && (this._equirectMaterial = _a(), this._compileMaterial(this._equirectMaterial));
	}
	dispose() {
	...
	_cleanup(e) {
		this._renderer.setRenderTarget(oa, sa, ca), this._renderer.xr.enabled = la, e.scissorTest = !1, ma(e, 0, 0, e.width, e.height);
	}
	_fromTexture(e, t) {
		e.mapping === 301 || e.mapping === 302 ? this._setSize(e.image.length === 0 ? 16 : e.image[0].width || e.image[0].image.width) : this._setSize(e.image.width / 4), oa = this._renderer.getRenderTarget(), sa = this._renderer.getActiveCubeFace(), ca = this._renderer.getActiveMipmapLevel(), la = this._renderer.xr.enabled, this._renderer.xr.enabled = !1;
	...
	_allocateTargets() {
		...
		if (this._pingPongRenderTarget === null || this._pingPongRenderTarget.width !== e || this._pingPongRenderTarget.height !== t) {
			...
			let { _lodMax: r } = this;
			({lodMeshes: this._lodMeshes, sizeLods: this._sizeLods, sigmas: this._sigmas} = fa(r)), this._blurMaterial = ga(r, e, t), this._ggxMaterial = ha(r, e, t);
		}
		return r;
	}
	_compileMaterial(e) {
		let t = new Zn(new On(), e);
		this._renderer.compile(t, ia);
	}
	_sceneToCubeUV(e, t, n, r, i) {
		let a = new gi(90, 1, t, n), o = [
			1,
			-1,
			1,
			1,
		...
		c.getClearColor(aa), c.toneMapping = 0, c.autoClear = !1, c.state.buffers.depth.getReversed() && (c.setRenderTarget(r), c.clearDepth(), c.setRenderTarget(null)), this._backgroundBox === null && (this._backgroundBox = new Zn(new Sr(), new zn({
		...
		m ? m.isColor && (f.color.copy(m), e.background = null, p = !0) : (f.color.copy(aa), p = !0);
		for (let t = 0; t < 6; t++) {
			let n = t % 3;
			...
			ma(r, n * l, t > 2 ? l : 0, l, l), c.setRenderTarget(r), p && c.render(d, a), c.render(e, a);
		}
		c.toneMapping = u, c.autoClear = l, e.background = m;
	}
	_textureToCubeUV(e, t) {
		let n = this._renderer, r = e.mapping === 301 || e.mapping === 302;
		r ? (this._cubemapMaterial === null && (this._cubemapMaterial = va()), this._cubemapMaterial.uniforms.flipEnvMap.value = e.isRenderTargetTexture === !1 ? -1 : 1) : this._equirectMaterial === null && (this._equirectMaterial = _a());
		let i = r ? this._cubemapMaterial : this._equirectMaterial, a = this._lodMeshes[0];
		a.material = i;
		let o = i.uniforms;
		o.envMap.value = e;
		let s = this._cubeSize;
		ma(t, 0, 0, 3 * s, 2 * s), n.setRenderTarget(t), n.render(a, ia);
	}
	_applyPMREM(e) {
	...
	_applyGGXFilter(e, t, n) {
		...
		o.material = a;
		let s = a.uniforms, c = n / (this._lodMeshes.length - 1), l = t / (this._lodMeshes.length - 1), u = Math.sqrt(c * c - l * l) * (0 + c * 1.25), { _lodMax: d } = this, f = this._sizeLods[n], p = 3 * f * (n > d - ea ? n - d + ea : 0), m = 4 * (this._cubeSize - f);
		s.envMap.value = e.texture, s.roughness.value = u, s.mipInt.value = d - t, ma(i, p, m, 3 * f, 2 * f), r.setRenderTarget(i), r.render(o, ia), s.envMap.value = i.texture, s.roughness.value = 0, s.mipInt.value = d - n, ma(e, p, m, 3 * f, 2 * f), r.setRenderTarget(e), r.render(o, ia);
	}
	_blur(e, t, n, r, i) {
	...
	_halfBlur(e, t, n, r, i, a, o) {
		...
		l.material = c;
		let u = c.uniforms, d = this._sizeLods[n] - 1, f = isFinite(i) ? Math.PI / (2 * d) : 2 * Math.PI / (2 * na - 1), p = i / f, m = isFinite(i) ? 1 + Math.floor(3 * p) : na;
		m > na && I(`sigmaRadians, ${i}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${na}`);
		let h = [], g = 0;
		for (let e = 0; e < na; ++e) {
		...
		ma(t, 3 * v * (r > _ - ea ? r - _ + ea : 0), 4 * (this._cubeSize - v), 3 * v, 2 * v), s.setRenderTarget(t), s.render(l, ia);
	}
};
function fa(e) {
	let t = [], n = [], r = [], i = e, a = e - ea + 1 + ta.length;
	for (let o = 0; o < a; o++) {
		let a = 2 ** i;
		t.push(a);
		let s = 1 / a;
		o > e - ea ? s = ta[o - e + ea - 1] : o === 0 && (s = 0), n.push(s);
		...
		let h = new On();
		h.setAttribute("position", new pn(f, 3)), h.setAttribute("uv", new pn(p, 2)), h.setAttribute("faceIndex", new pn(m, 1)), r.push(new Zn(h, null)), i > ea && i--;
	}
	return {
		lodMeshes: r,
		sizeLods: t,
...
function ga(e, t, n) {
	let r = new Float32Array(na), i = new G(0, 1, 0);
	return new Ir({
...
var ba = class extends qe {
	...
	fromEquirectangularTexture(e, t) {
		...
		let o = new Zn(r, a), s = t.minFilter;
	...
	function o(t) {
		if (t && t.isTexture) {
			...
			if (a || o) {
				...
				if (t.isRenderTargetTexture && t.pmremVersion !== s) return r === null && (r = new da(e)), i = a ? r.fromEquirectangular(t, i) : r.fromCubemap(t, i), i.texture.pmremVersion = t.pmremVersion, n.set(t, i), i.texture;
				if (i !== void 0) return i.texture;
				{
					let s = t.image;
					return a && s && s.height > 0 || o && s && c(s) ? (r === null && (r = new da(e)), i = a ? r.fromEquirectangular(t) : r.fromCubemap(t), i.texture.pmremVersion = t.pmremVersion, n.set(t, i), t.addEventListener("dispose", u), i.texture) : null;
				}
			}
		}
		return t;
...
function Ea(e, t, n) {
	let r = /* @__PURE__ */ new WeakMap(), i = new Ge();
	function a(a, o, s) {
		...
		if (f === void 0 || f.count !== d) {
			...
			let g = new Float32Array(m * h * 4 * d), _ = new Je(g, m, h, d);
...
function ka(e, t, n, r, i, a) {
	let o = new qe(t, n, {
		...
		stencilBuffer: a,
		samples: r ? 4 : 0,
		depthTexture: i ? new yr(t, n) : void 0
	}), s = new qe(t, n, {
		type: u,
		depthBuffer: !1,
		stencilBuffer: !1
	...
	let l = new Lr({
		...
		depthTest: !1,
		depthWrite: !1
	}), d = new Zn(c, l), f = new yi(-1, 1, 1, -1, 0, 1), p = null, m = null, h = !1, g, _ = null, v = [], y = !1;
	this.setSize = function(e, t) {
		...
		if (p !== e.outputColorSpace || m !== e.toneMapping) {
			p = e.outputColorSpace, m = e.toneMapping, l.defines = {}, X.getTransfer(p) === "srgb" && (l.defines.SRGB_TRANSFER = "");
			let t = Oa[m];
...
var Aa = /*@__PURE__*/ new We(), ja = /*@__PURE__*/ new yr(1, 1), Ma = /*@__PURE__*/ new Je(), Na = /*@__PURE__*/ new Ye(), Pa = /*@__PURE__*/ new vr(), Fa = [], Ia = [], La = /* @__PURE__ */ new Float32Array(16), Ra = /* @__PURE__ */ new Float32Array(9), za = /* @__PURE__ */ new Float32Array(4);
function Ba(e, t, n) {
	let r = e[0];
	if (r <= 0 || r > 0) return e;
	let i = t * n, a = Fa[i];
	if (a === void 0 && (a = new Float32Array(i), Fa[i] = a), t !== 0) {
		r.toArray(a, 0);
...
function Ua(e, t) {
	let n = Ia[t];
	n === void 0 && (n = new Int32Array(t), Ia[t] = n);
...
function qa(e, t) {
	...
	if (t.x !== void 0) (n[0] !== t.x || n[1] !== t.y || n[2] !== t.z || n[3] !== t.w) && (e.uniform4f(this.addr, t.x, t.y, t.z, t.w), n[0] = t.x, n[1] = t.y, n[2] = t.z, n[3] = t.w);
		...
		if (Va(n, t)) return;
		e.uniform4fv(this.addr, t), Ha(n, t);
	}
}
function Ja(e, t) {
	...
	if (r === void 0) {
		...
		if (Va(n, r)) return;
		za.set(r), e.uniformMatrix2fv(this.addr, !1, za), Ha(n, r);
	}
}
function Ya(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		...
		if (Va(n, r)) return;
		Ra.set(r), e.uniformMatrix3fv(this.addr, !1, Ra), Ha(n, r);
	}
}
function Xa(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		...
		if (Va(n, r)) return;
		La.set(r), e.uniformMatrix4fv(this.addr, !1, La), Ha(n, r);
	}
}
function Za(e, t) {
	let n = this.cache;
...
function ao(e, t, n) {
	...
	let a;
	this.type === e.SAMPLER_2D_SHADOW ? (ja.compareFunction = n.isReversedDepthBuffer() ? 518 : 515, a = ja) : a = Aa, n.setTexture2D(t || a, i);
}
function oo(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTexture3D(t || Na, i);
}
function so(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTextureCube(t || Pa, i);
}
function co(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTexture2DArray(t || Ma, i);
}
function lo(e) {
	switch (e) {
		case 5126: return Wa;
		case 35664: return Ga;
		case 35665: return Ka;
		case 35666: return qa;
		case 35674: return Ja;
		case 35675: return Ya;
		case 35676: return Xa;
		case 5124:
		case 35670: return Za;
		case 35667:
		case 35671: return Qa;
		case 35668:
		case 35672: return $a;
		case 35669:
		case 35673: return eo;
		case 5125: return to;
		case 36294: return no;
		case 36295: return ro;
		case 36296: return io;
		case 35678:
		case 36198:
		case 36298:
		case 36306:
		case 35682: return ao;
		case 35679:
		case 36299:
		...
		case 36300:
		case 36308:
		case 36293: return so;
		case 36289:
		case 36303:
		case 36311:
		case 36292: return co;
	}
}
function uo(e, t) {
...
function fo(e, t) {
	let n = Ba(t, this.size, 2);
	e.uniform2fv(this.addr, n);
}
function po(e, t) {
	let n = Ba(t, this.size, 3);
	e.uniform3fv(this.addr, n);
}
function mo(e, t) {
	let n = Ba(t, this.size, 4);
...
function go(e, t) {
	let n = Ba(t, this.size, 9);
	e.uniformMatrix3fv(this.addr, !1, n);
}
function _o(e, t) {
	let n = Ba(t, this.size, 16);
...
function Eo(e, t, n) {
	let r = this.cache, i = t.length, a = Ua(n, i);
	Va(r, a) || (e.uniform1iv(this.addr, a), Ha(r, a));
	let o;
	o = this.type === e.SAMPLER_2D_SHADOW ? ja : Aa;
	for (let e = 0; e !== i; ++e) n.setTexture2D(t[e] || o, a[e]);
}
function Do(e, t, n) {
	let r = this.cache, i = t.length, a = Ua(n, i);
	Va(r, a) || (e.uniform1iv(this.addr, a), Ha(r, a));
	for (let e = 0; e !== i; ++e) n.setTexture3D(t[e] || Na, a[e]);
}
function Oo(e, t, n) {
	let r = this.cache, i = t.length, a = Ua(n, i);
	Va(r, a) || (e.uniform1iv(this.addr, a), Ha(r, a));
	for (let e = 0; e !== i; ++e) n.setTextureCube(t[e] || Pa, a[e]);
}
function ko(e, t, n) {
	let r = this.cache, i = t.length, a = Ua(n, i);
	Va(r, a) || (e.uniform1iv(this.addr, a), Ha(r, a));
	for (let e = 0; e !== i; ++e) n.setTexture2DArray(t[e] || Ma, a[e]);
}
function Ao(e) {
	switch (e) {
		case 5126: return uo;
		case 35664: return fo;
		case 35665: return po;
		case 35666: return mo;
		case 35674: return ho;
		case 35675: return go;
		case 35676: return _o;
		case 5124:
		case 35670: return vo;
		case 35667:
		case 35671: return yo;
		case 35668:
		case 35672: return bo;
		case 35669:
		case 35673: return xo;
		case 5125: return So;
		case 36294: return Co;
		case 36295: return wo;
		case 36296: return To;
		case 35678:
		case 36198:
		case 36298:
		case 36306:
		case 35682: return Eo;
		case 35679:
		case 36299:
		case 36307: return Do;
		case 35680:
		case 36300:
		case 36308:
		case 36293: return Oo;
		case 36289:
		case 36303:
		case 36311:
...
var jo = class {
	...
	constructor(e, t, n) {
		this.id = e, this.addr = n, this.cache = [], this.type = t.type, this.size = t.size, this.setValue = Ao(t.type);
	}
}, No = class {
	constructor(e) {
...
function Io(e, t, n) {
	...
	for (Po.lastIndex = 0;;) {
		let a = Po.exec(r), o = Po.lastIndex, s = a[1], c = a[2] === "]", l = a[3];
		if (c && (s |= 0), l === void 0 || l === "[" && o + 2 === i) {
			Fo(n, l === void 0 ? new jo(s, e, t) : new Mo(s, e, t));
			break;
		} else {
			let e = n.map[s];
			e === void 0 && (e = new No(s), Fo(n, e)), n = e;
		}
	}
}
var Lo = class {
	constructor(e, t) {
		...
		for (let r = 0; r < n; ++r) {
			...
			Io(n, e.getUniformLocation(t, n.name), this);
		}
		let r = [], i = [];
...
var Jo = /*@__PURE__*/ new G();
function Yo() {
	return X.getLuminanceCoefficients(Jo), [
		"float luminance( const in vec3 rgb ) {",
		`	const vec3 weights = vec3( ${Jo.x.toFixed(4)}, ${Jo.y.toFixed(4)}, ${Jo.z.toFixed(4)} );`,
		"	return dot( weights, rgb );",
		"}"
	].join("\n");
}
function Xo(e) {
	return [e.extensionClipCullDistance ? "#extension GL_ANGLE_clip_cull_distance : require" : "", e.extensionMultiDraw ? "#extension GL_ANGLE_multi_draw : require" : ""].filter($o).join("\n");
}
function Zo(e) {
	let t = [];
	for (let n in e) {
...
var os = /#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;
function ss(e) {
	return e.replace(os, cs);
}
function cs(e, t, n, r) {
	let i = "";
...
function ds(e) {
	return us[e.shadowMapType] || "SHADOWMAP_TYPE_BASIC";
}
var fs = {
...
function ps(e) {
	return e.envMap === !1 ? "ENVMAP_TYPE_CUBE" : fs[e.envMapMode] || "ENVMAP_TYPE_CUBE";
}
var ms = { 302: "ENVMAP_MODE_REFRACTION" };
function hs(e) {
	return e.envMap === !1 ? "ENVMAP_MODE_REFLECTION" : ms[e.envMapMode] || "ENVMAP_MODE_REFLECTION";
}
var gs = {
...
function _s(e) {
	return e.envMap === !1 ? "ENVMAP_BLENDING_NONE" : gs[e.combine] || "ENVMAP_BLENDING_NONE";
}
function vs(e) {
...
function ys(e, t, n, r) {
	let i = e.getContext(), a = n.defines, o = n.vertexShader, s = n.fragmentShader, c = ds(n), l = ps(n), u = hs(n), d = _s(n), f = vs(n), p = Xo(n), m = Zo(a), h = i.createProgram(), g, _, v = n.glslVersion ? "#version " + n.glslVersion + "\n" : "";
	n.isRawShaderMaterial ? (g = [
		...
		n.toneMapping === 0 ? "" : qo("toneMapping", n.toneMapping),
	...
	let y = v + g + o, b = v + _ + s, x = Ro(i, i.VERTEX_SHADER, y), S = Ro(i, i.FRAGMENT_SHADER, b);
	...
	function C(t) {
		if (e.debug.checkShaderErrors) {
			...
			if (i.getProgramParameter(h, i.LINK_STATUS) === !1) if (l = !1, typeof e.debug.onShaderError == "function") e.debug.onShaderError(i, h, x, S);
				...
				let e = Wo(i, x, "vertex"), n = Wo(i, S, "fragment");
		...
		i.deleteShader(x), i.deleteShader(S), w = new Lo(i, h), T = Qo(i, h);
	}
	let w;
	...
	return this.isReady = function() {
		return E === !1 && (E = i.getProgramParameter(h, zo)), E;
	}, this.destroy = function() {
		r.releaseStatesOfProgram(this), i.deleteProgram(h), this.program = void 0;
	}, this.type = n.shaderType, this.name = n.shaderName, this.id = Bo++, this.cacheKey = t, this.usedTimes = 1, this.program = h, this.vertexShader = x, this.fragmentShader = S, this;
}
var bs = 0, xs = class {
	constructor() {
	...
	_getShaderStage(e) {
		...
		return n === void 0 && (n = new Ss(e), t.set(e, n)), n;
	}
}, Ss = class {
	constructor(e) {
		this.id = bs++, this.code = e, this.usedTimes = 0;
	}
};
function Cs(e) {
...
function ws(e, t, n, r, i, a) {
	let o = new st(), s = new xs(), c = /* @__PURE__ */ new Set(), l = [], u = /* @__PURE__ */ new Map(), d = r.logarithmicDepthBuffer, f = r.precision, p = {
	...
	function h(i, o, l, u, h, g) {
		...
		let ke = {
			...
			packedNormalMap: ae && i.normalMapType === 0 && Cs(i.normalMap.format),
			metalnessMap: oe,
			roughnessMap: se,
			anisotropy: z,
			anisotropyMap: H,
			...
			anisotropyMapUv: H && m(i.anisotropyMap.channel),
			...
			pointsUvs: h.isPoints === !0 && !!v.attributes.uv && (te || we),
			fog: !!_,
			useFog: i.fog === !0,
			...
			decodeVideoTextureEmissive: R && i.emissiveMap.isVideoTexture === !0 && X.getTransfer(i.emissiveMap.colorSpace) === "srgb",
			...
			extensionMultiDraw: (De && i.extensions.multiDraw === !0 || ee) && n.has("WEBGL_multi_draw"),
...
function Os() {
	...
	function u(e, t, a) {
		n.length > 1 && n.sort(e || Es), r.length > 1 && r.sort(t || Ds), i.length > 1 && i.sort(t || Ds), a && (n.reverse(), r.reverse(), i.reverse());
	}
	function d() {
...
function ks() {
	...
	function t(t, n) {
		let r = e.get(t), i;
		return r === void 0 ? (i = new Os(), e.set(t, [i])) : n >= r.length ? (i = new Os(), r.push(i)) : i = r[n], i;
	}
	function n() {
		e = /* @__PURE__ */ new WeakMap();
	}
...
function Is(e) {
	...
	function n(n, r = 0) {
		let i = t.get(n), a;
		return i === void 0 ? (a = new Fs(e), t.set(n, [a])) : r >= i.length ? (a = new Fs(e), i.push(a)) : a = i[r], a;
	}
	function r() {
...
var Ls = "void main() {\n	gl_Position = vec4( position, 1.0 );\n}", Rs = "uniform sampler2D shadow_pass;\nuniform vec2 resolution;\nuniform float radius;\nvoid main() {\n	const float samples = float( VSM_SAMPLES );\n	float mean = 0.0;\n	float squared_mean = 0.0;\n	float uvStride = samples <= 1.0 ? 0.0 : 2.0 / ( samples - 1.0 );\n	float uvStart = samples <= 1.0 ? 0.0 : - 1.0;\n	for ( float i = 0.0; i < samples; i ++ ) {\n		float uvOffset = uvStart + i * uvStride;\n		#ifdef HORIZONTAL_PASS\n			vec2 distribution = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( uvOffset, 0.0 ) * radius ) / resolution ).rg;\n			mean += distribution.x;\n			squared_mean += distribution.y * distribution.y + distribution.x * distribution.x;\n		#else\n			float depth = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( 0.0, uvOffset ) * radius ) / resolution ).r;\n			mean += depth;\n			squared_mean += depth * depth;\n		#endif\n	}\n	mean = mean / samples;\n	squared_mean = squared_mean / samples;\n	float std_dev = sqrt( max( 0.0, squared_mean - mean * mean ) );\n	gl_FragColor = vec4( mean, std_dev, 0.0, 1.0 );\n}", zs = [
	...
	/*@__PURE__*/ new G(0, -1, 0),
	/*@__PURE__*/ new G(0, -1, 0)
], Vs = /*@__PURE__*/ new Xe(), Hs = /*@__PURE__*/ new G(), Us = /*@__PURE__*/ new G();
function Ws(e, t, n) {
	let a = new _r(), o = new U(), s = new U(), d = new Ge(), f = new Br(), p = new Vr(), m = {}, g = n.maxTextureSize, _ = {
		0: 1,
		1: 0,
		2: 2
	}, v = new Ir({
	...
	this.render = function(t, n, f) {
		...
		for (let p = 0, m = t.length; p < m; p++) {
			...
			if (_.camera._reversedDepth = S, _.map === null || b === !0) {
				...
				} else m.isPointLight ? (_.map = new ba(o.x), _.map.depthTexture = new br(o.x, c)) : (_.map = new qe(o.x, o.y), _.map.depthTexture = new yr(o.x, o.y, c)), _.map.depthTexture.name = m.name + ".shadowMap", _.map.depthTexture.format = h, this.type === 1 ? (_.map.depthTexture.compareFunction = S ? 518 : 515, _.map.depthTexture.minFilter = i, _.map.depthTexture.magFilter = i) : (_.map.depthTexture.compareFunction = null, _.map.depthTexture.minFilter = r, _.map.depthTexture.magFilter = r);
...
function Gs(e, t) {
	function n() {
		let t = !1, n = new Ge(), r = null, i = new Ge(0, 0, 0, 0);
		return {
			setMask: function(n) {
	...
	let P = null, ne = {}, re = e.getParameter(e.SCISSOR_BOX), F = e.getParameter(e.VIEWPORT), ie = new Ge().fromArray(re), ae = new Ge().fromArray(F);
	function I(t, n, r, i) {
...
function Ks(o, s, c, l, u, d, f) {
	...
	function pe(e, t, n) {
		...
		if (a.version !== s.__version || i === !0) {
			if (c.activeTexture(o.TEXTURE0 + n), !(typeof ImageBitmap < "u" && t.image instanceof ImageBitmap)) {
				let e = X.getPrimaries(X.workingColorSpace), n = t.colorSpace === "" ? null : X.getPrimaries(t.colorSpace), r = t.colorSpace === "" || e === n ? o.NONE : o.BROWSER_DEFAULT_WEBGL;
			...
			if (t.isDepthTexture) p = O(t.format === g, t.type), y && (_ ? c.texStorage2D(o.TEXTURE_2D, 1, p, e.width, e.height) : c.texImage2D(o.TEXTURE_2D, 0, p, e.width, e.height, 0, l, f, null));
				...
				for (let n = 0, r = h.length; n < r; n++) if (m = h[n], t.format !== 1023) if (l !== null) if (_) {
					if (b) if (t.layerUpdates.size > 0) {
						let e = Vi(m.width, m.height, t.format, t.type);
				...
				if (y && c.texStorage3D(o.TEXTURE_2D_ARRAY, x, p, e.width, e.height, e.depth), b) if (t.layerUpdates.size > 0) {
					let n = Vi(e.width, e.height, t.format, t.type);
					for (let r of t.layerUpdates) {
	...
	function me(e, t, n) {
		...
		if (i.version !== a.__version || r === !0) {
			...
			let e = X.getPrimaries(X.workingColorSpace), s = t.colorSpace === "" ? null : X.getPrimaries(t.colorSpace), l = t.colorSpace === "" || e === s ? o.NONE : o.BROWSER_DEFAULT_WEBGL;
	...
	function ve(e) {
		...
		if (e.depthTexture && !t.__autoAllocateDepthBuffer) if (n) for (let n = 0; n < 6; n++) _e(t.__webglFramebuffer[n], e, n);
		else {
			...
			for (let n = 0; n < 6; n++) if (c.bindFramebuffer(o.FRAMEBUFFER, t.__webglFramebuffer[n]), t.__webglDepthbuffer[n] === void 0) t.__webglDepthbuffer[n] = o.createRenderbuffer(), ge(t.__webglDepthbuffer[n], e, !1);
			else {
			...
			let n = e.texture.mipmaps;
			if (n && n.length > 0 ? c.bindFramebuffer(o.FRAMEBUFFER, t.__webglFramebuffer[0]) : c.bindFramebuffer(o.FRAMEBUFFER, t.__webglFramebuffer), t.__webglDepthbuffer === void 0) t.__webglDepthbuffer = o.createRenderbuffer(), ge(t.__webglDepthbuffer, e, !1);
			else {
	...
	function ye(e, t, n) {
		let r = l.get(e);
		t !== void 0 && he(r.__webglFramebuffer, e, e.texture, o.COLOR_ATTACHMENT0, o.TEXTURE_2D, 0), n !== void 0 && ve(e);
	}
	function be(e) {
		...
		if (s || (r.__webglTexture === void 0 && (r.__webglTexture = o.createTexture()), r.__version = t.version, f.memory.textures++), a) {
			...
			if (e.samples > 0 && Ee(e) === !1) {
				...
				o.bindRenderbuffer(o.RENDERBUFFER, null), e.depthBuffer && (n.__webglDepthRenderbuffer = o.createRenderbuffer(), ge(n.__webglDepthRenderbuffer, e, !0)), c.bindFramebuffer(o.FRAMEBUFFER, null);
			}
		}
		if (a) {
			...
			for (let t = 0, r = i.length; t < r; t++) {
				...
				(e.isWebGL3DRenderTarget || e.isWebGLArrayRenderTarget) && (s = e.isWebGL3DRenderTarget ? o.TEXTURE_3D : o.TEXTURE_2D_ARRAY), c.bindTexture(s, a.__webglTexture), V(s, r), he(n.__webglFramebuffer, e, r, o.COLOR_ATTACHMENT0 + t, s, 0), w(r) && T(s);
			}
			c.unbindTexture();
		} else {
			let i = o.TEXTURE_2D;
			if ((e.isWebGL3DRenderTarget || e.isWebGLArrayRenderTarget) && (i = e.isWebGL3DRenderTarget ? o.TEXTURE_3D : o.TEXTURE_2D_ARRAY), c.bindTexture(i, r.__webglTexture), V(i, t), t.mipmaps && t.mipmaps.length > 0) for (let r = 0; r < t.mipmaps.length; r++) he(n.__webglFramebuffer[r], e, t, o.COLOR_ATTACHMENT0, i, r);
	...
	function Oe(e, t) {
		...
		return e.isCompressedTexture === !0 || e.isVideoTexture === !0 || n !== "srgb-linear" && n !== "" && (X.getTransfer(n) === "srgb" ? (r !== 1023 || i !== 1009) && I("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType.") : L("WebGLTextures: Unsupported texture color space:", n)), t;
	}
	function ke(e) {
...
var Js = "\nvoid main() {\n\n	gl_Position = vec4( position, 1.0 );\n\n}", Ys = "\nuniform sampler2DArray depthColor;\nuniform float depthWidth;\nuniform float depthHeight;\n\nvoid main() {\n\n	vec2 coord = vec2( gl_FragCoord.x / depthWidth, gl_FragCoord.y / depthHeight );\n\n	if ( coord.x >= 1.0 ) {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x - 1.0, coord.y, 1 ) ).r;\n\n	} else {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;\n\n	}\n\n}", Xs = class {
	...
	getMesh(e) {
		if (this.texture !== null && this.mesh === null) {
			...
			this.mesh = new Zn(new Tr(20, 20), n);
		}
		return this.mesh;
	}
	reset() {
	...
	constructor(e, t) {
		super();
		let n = this, r = null, i = 1, a = null, s = "local-floor", l = 1, u = null, d = null, f = null, _ = null, v = null, y = null, b = typeof XRWebGLBinding < "u", x = new Xs(), S = {}, C = t.getContextAttributes(), w = null, T = null, E = [], D = [], O = new U(), k = null, A = new gi();
		A.viewport = new Ge();
		let j = new gi();
		j.viewport = new Ge();
		let M = [A, j], N = new Ei(), ee = null, te = null;
		this.cameraAutoUpdate = !0, this.enabled = !1, this.isPresenting = !1, this.getController = function(e) {
			let t = E[e];
			return t === void 0 && (t = new Et(), E[e] = t), t.getTargetRaySpace();
		}, this.getControllerGrip = function(e) {
			let t = E[e];
			return t === void 0 && (t = new Et(), E[e] = t), t.getGripSpace();
		}, this.getHand = function(e) {
			let t = E[e];
			return t === void 0 && (t = new Et(), E[e] = t), t.getHandSpace();
		};
		function P(e) {
...
}, Qs = /*@__PURE__*/ new Xe(), $s = /*@__PURE__*/ new K();
...
function ec(e, t) {
	...
	function r(t, n) {
		n.color.getRGB(t.fogColor.value, Mr(e)), n.isFog ? (t.fogNear.value = n.near, t.fogFar.value = n.far) : n.isFogExp2 && (t.fogDensity.value = n.density);
	}
	...
	function a(e, r) {
		...
		a && (e.envMap.value = a, e.envMapRotation.value.setFromMatrix4(Qs.makeRotationFromEuler(o)).transpose(), a.isCubeTexture && a.isRenderTargetTexture === !1 && e.envMapRotation.value.premultiply($s), e.reflectivity.value = r.reflectivity, e.ior.value = r.ior, e.refractionRatio.value = r.refractionRatio), r.lightMap && (e.lightMap.value = r.lightMap, e.lightMapIntensity.value = r.lightMapIntensity, n(r.lightMap, e.lightMapTransform)), r.aoMap && (e.aoMap.value = r.aoMap, e.aoMapIntensity.value = r.aoMapIntensity, n(r.aoMap, e.aoMapTransform));
	}
	function o(e, t) {
...
function ic() {
	return rc === null && (rc = new er(nc, 16, 16, y, u), rc.name = "DFG_LUT", rc.minFilter = i, rc.magFilter = i, rc.wrapS = t, rc.wrapT = t, rc.generateMipmaps = !1, rc.needsUpdate = !0), rc;
}
var ac = class {
	constructor(e = {}) {
		...
		let T = C, E = /* @__PURE__ */ new Set([
			...
			d,
			f
		]), O = /* @__PURE__ */ new Uint32Array(4), A = /* @__PURE__ */ new Int32Array(4), j = new G(), M = null, N = null, te = [], P = [], ne = null;
		...
		let le = 0, ue = 0, B = null, V = -1, H = null, de = new Ge(), fe = new Ge(), pe = null, me = new Z(0), he = 0, ge = t.width, _e = t.height, ve = 1, ye = null, be = null, xe = new Ge(0, 0, ge, _e), Se = new Ge(0, 0, ge, _e), Ce = !1, we = new _r(), Te = !1, Ee = !1, De = new Xe(), Oe = new G(), ke = new Ge(), Ae = {
			background: null,
			fog: null,
			environment: null,
		...
		try {
			...
			if ("setAttribute" in t && t.setAttribute("data-engine", "three.js r185"), t.addEventListener("webglcontextlost", rt, !1), t.addEventListener("webglcontextrestored", it, !1), t.addEventListener("webglcontextcreationerror", at, !1), W === null) {
				let t = "webgl2";
		...
		let Ne, K, q, Pe, J, Y, Fe, Ie, Le, Re, ze, Be, Ve, He, Ue, We, Ke, Je, Ye, Ze, Qe, $e, et;
		function tt() {
			Ne = new Sa(W), Ne.init(), Qe = new qs(W, Ne), K = new Qi(W, Ne, e, Qe), q = new Gs(W, Ne), K.reversedDepthBuffer && S && q.buffers.depth.setReversed(!0), se = W.createFramebuffer(), z = W.createFramebuffer(), ce = W.createFramebuffer(), Pe = new Ta(W), J = new Ts(), Y = new Ks(W, Ne, q, J, K, Qe, Pe), Fe = new xa(F), Ie = new Wi(W), $e = new Xi(W, Ie), Le = new Ca(W, Ie, Pe, $e), Re = new Da(W, Le, Ie, $e, Pe), Je = new Ea(W, K, Y), Ue = new $i(J), ze = new ws(F, Fe, Ne, K, $e, Ue), Be = new ec(F, J), Ve = new ks(), He = new Is(Ne), Ke = new Yi(F, Fe, q, Re, w, h), We = new Ws(F, Re, K), et = new tc(W, Pe, K, q), Ye = new Zi(W, Ne, Pe), Ze = new wa(W, Ne, Pe), Pe.programs = ze.programs, F.capabilities = K, F.extensions = Ne, F.properties = J, F.renderLists = Ve, F.shadowMap = We, F.state = q, F.info = Pe;
		}
		tt(), T !== 1009 && (ne = new ka(T, t.width, t.height, m, r, i));
		let nt = new Zs(F, W);
		this.xr = nt, this.getContext = function() {
			...
			e.isVector4 ? xe.set(e.x, e.y, e.z, e.w) : xe.set(e, t, n, r), q.viewport(de.copy(xe).multiplyScalar(ve).round());
		}, this.getScissor = function(e) {
			return e.copy(Se);
		}, this.setScissor = function(e, t, n, r) {
			e.isVector4 ? Se.set(e.x, e.y, e.z, e.w) : Se.set(e, t, n, r), q.scissor(fe.copy(Se).multiplyScalar(ve).round());
		...
		function it() {
			...
			tt(), Pe.autoReset = e, We.enabled = t, We.autoUpdate = n, We.needsUpdate = r, We.type = i;
		}
		function at(e) {
		...
		this.renderBufferDirect = function(e, t, n, r, i, a) {
			...
			$e.setup(i, r, s, n, c);
			let h, g = Ye;
			if (c !== null && (h = Ie.get(c), g = Ze, g.setIndex(h)), i.isMesh) r.wireframe === !0 ? (q.setLineWidth(r.wireframeLinewidth * U()), g.setMode(W.LINES)) : g.setMode(W.TRIANGLES);
			else if (i.isLine) {
				let e = r.linewidth;
				e === void 0 && (e = 1), q.setLineWidth(e * U()), i.isLineSegments ? g.setMode(W.LINES) : i.isLineLoop ? g.setMode(W.LINE_LOOP) : g.setMode(W.LINE_STRIP);
		...
		mt.setAnimationLoop(dt), typeof self < "u" && mt.setContext(self), this.setAnimationLoop = function(e) {
			...
			if (e.matrixWorldAutoUpdate === !0 && e.updateMatrixWorld(), t.parent === null && t.matrixWorldAutoUpdate === !0 && t.updateMatrixWorld(), nt.enabled === !0 && nt.isPresenting === !0 && (ne === null || ne.isCompositing() === !1) && (nt.cameraAutoUpdate === !0 && nt.updateCamera(t), t = nt.getCamera()), e.isScene === !0 && e.onBeforeRender(F, e, t, B), N = He.get(e, P.length), N.init(t), N.state.textureUnits = Y.getTextureUnits(), P.push(N), De.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), we.setFromProjectionMatrix(De, ee, t.reversedDepth), Ee = this.localClippingEnabled, Te = Ue.init(this.clippingPlanes, Ee), M = Ve.get(e, te.length), M.init(), te.push(M), nt.enabled === !0 && nt.isPresenting === !0) {
				let e = F.xr.getDepthSensingMesh();
				e !== null && ht(e, t, -Infinity, F.sortObjects);
			}
			ht(e, t, 0, F.sortObjects), M.finish(), F.sortObjects === !0 && M.sort(ye, be, t.reversedDepth), je = nt.enabled === !1 || nt.isPresenting === !1 || nt.hasDepthSensing() === !1, je && Ke.addToRenderList(M, e), this.info.render.frame++, this.info.autoReset === !0 && this.info.reset(), Te === !0 && Ue.beginShadows();
			let i = N.state.shadowsArray;
			if (We.render(i, e, t), Te === !0 && Ue.endShadows(), (r && ne.hasRenderPass()) === !1) {
			...
			B !== null && ue === 0 && (Y.updateMultisampleRenderTarget(B), Y.updateRenderTargetMipmap(B)), r && ne.end(F), e.isScene === !0 && e.onAfterRender(F, e, t), $e.resetDefaultState(), V = -1, H = null, P.pop(), P.length > 0 ? (N = P[P.length - 1], Y.setTextureUnits(N.state.textureUnits), Te === !0 && Ue.setGlobalState(F.clippingPlanes, N.state.camera)) : N = null, te.pop(), M = te.length > 0 ? te[te.length - 1] : null, R !== null && R.renderEnd();
		};
		function ht(e, t, n, r) {
			...
			if (e.layers.test(t.layers)) {
				if (e.isGroup) n = e.renderOrder;
					...
					if (!e.frustumCulled || we.intersectsSprite(e)) {
						...
						i.visible && M.push(e, t, i, n, ke.z, null);
					}
					...
					if (r && (e.boundingSphere === void 0 ? (t.boundingSphere === null && t.computeBoundingSphere(), ke.copy(t.boundingSphere.center)) : (e.boundingSphere === null && e.computeBoundingSphere(), ke.copy(e.boundingSphere.center)), ke.applyMatrix4(e.matrixWorld).applyMatrix4(De)), Array.isArray(i)) {
						...
						for (let a = 0, o = r.length; a < o; a++) {
							...
							s && s.visible && M.push(e, t, s, n, ke.z, o);
						}
					} else i.visible && M.push(e, t, i, n, ke.z, null);
				}
			}
			let i = e.children;
		...
		function gt(e, t, n, r) {
			...
			N.setupLightsView(n), Te === !0 && Ue.setGlobalState(F.clippingPlanes, n), r && q.viewport(de.copy(r)), i.length > 0 && vt(i, t, n), a.length > 0 && vt(a, t, n), o.length > 0 && vt(o, t, n), q.buffers.depth.setTest(!0), q.buffers.depth.setMask(!0), q.buffers.color.setMask(!0), q.setPolygonOffset(!1);
		}
		function _t(e, t, n, r) {
			...
			F.setRenderTarget(s), F.getClearColor(me), he = F.getClearAlpha(), he < 1 && F.setClearColor(16777215, .5), F.clear(), je && Ke.render(n);
			let p = F.toneMapping;
			F.toneMapping = 0;
			let m = r.viewport;
			if (r.viewport !== void 0 && (r.viewport = void 0), N.setupLightsView(r), Te === !0 && Ue.setGlobalState(F.clippingPlanes, r), vt(e, n, r), Y.updateMultisampleRenderTarget(s), Y.updateRenderTargetMipmap(s), Ne.has("WEBGL_multisampled_render_to_texture") === !1) {
				let e = !1;
				for (let i = 0, a = t.length; i < a; i++) {
			...
			F.setRenderTarget(l, d, f), F.setClearColor(me, he), m !== void 0 && (r.viewport = m), F.toneMapping = p;
		}
		function vt(e, t, n) {
		...
		function bt(e, t, n) {
			...
			} else s.uniforms = ze.getUniforms(e), R !== null && e.isNodeMaterial && R.build(e, n, s), e.onBeforeCompile(s, F), d = ze.acquireProgram(s, c), l.set(c, d), r.uniforms = s.uniforms;
			let f = r.uniforms;
		...
		function xt(e) {
			if (e.uniformsList === null) {
				...
				e.uniformsList = Lo.seqWithValue(t.seq, e.uniforms);
			}
		...
		function wt(e, t, n, r, i) {
			...
			let a = t.fog, o = r.isMeshStandardMaterial || r.isMeshLambertMaterial || r.isMeshPhongMaterial ? t.environment : null, s = B === null ? F.outputColorSpace : B.isXRRenderTarget === !0 ? B.texture.colorSpace : X.workingColorSpace, c = r.isMeshStandardMaterial || r.isMeshLambertMaterial && !r.envMap || r.isMeshPhongMaterial && !r.envMap, l = Fe.get(r.envMap || o, c), u = r.vertexColors === !0 && !!n.attributes.color && n.attributes.color.itemSize === 4, d = !!n.attributes.tangent && (!!r.normalMap || r.anisotropy > 0), f = !!n.morphAttributes.position, p = !!n.morphAttributes.normal, m = !!n.morphAttributes.color, h = 0;
			...
			if ((D.position !== void 0 || D.normal !== void 0 || D.color !== void 0) && Je.update(i, n, x), (C || v.receiveShadow !== i.receiveShadow) && (v.receiveShadow = i.receiveShadow, T.setValue(W, "receiveShadow", i.receiveShadow)), (r.isMeshStandardMaterial || r.isMeshLambertMaterial || r.isMeshPhongMaterial) && r.envMap === null && t.environment !== null && (E.envMapIntensity.value = t.environmentIntensity), E.dfgLUT !== void 0 && (E.dfgLUT.value = ic()), C) {
				if (T.setValue(W, "toneMappingExposure", F.toneMappingExposure), v.needsLights && Tt(E, w), a && r.fog === !0 && Be.refreshFogUniforms(E, a), Be.refreshMaterialUniforms(E, r, ve, _e, N.state.transmissionRenderTarget[e.id]), v.needsLights && v.lightProbeGrid) {
				...
				Lo.upload(W, xt(v), E, Y);
			}
			if (r.isShaderMaterial && r.uniformsNeedUpdate === !0 && (Lo.upload(W, xt(v), E, Y), r.uniformsNeedUpdate = !1), r.isSpriteMaterial && T.setValue(W, "center", i.center), T.setValue(W, "modelViewMatrix", i.modelViewMatrix), T.setValue(W, "normalMatrix", i.normalMatrix), T.setValue(W, "modelMatrix", i.matrixWorld), r.uniformsGroups !== void 0) {
		...
		this.getActiveCubeFace = function() {
			...
			if (e) {
				...
				if (o.__useDefaultFramebuffer !== void 0) {
					q.bindFramebuffer(W.FRAMEBUFFER, o.__webglFramebuffer), de.copy(e.viewport), fe.copy(e.scissor), pe = e.scissorTest, q.viewport(de), q.scissor(fe), q.setScissorTest(pe), V = -1;
					return;
				...
				e.isWebGLCubeRenderTarget ? (r = Array.isArray(c[t]) ? c[t][n] : c[t], i = !0) : r = e.samples > 0 && Y.useMultisampledRTT(e) === !1 ? J.get(e).__webglMultisampledFramebuffer : Array.isArray(c) ? c[n] : c, de.copy(e.viewport), fe.copy(e.scissor), pe = e.scissorTest;
			} else de.copy(xe).multiplyScalar(ve).floor(), fe.copy(Se).multiplyScalar(ve).floor(), pe = Ce;
			if (n !== 0 && (r = se), q.bindFramebuffer(W.FRAMEBUFFER, r) && q.drawBuffers(e, r), q.viewport(de), q.scissor(fe), q.setScissorTest(pe), i) {
			...
			if (e.isWebGLCubeRenderTarget && o !== void 0 && (c = c[o]), c) {
				q.bindFramebuffer(W.FRAMEBUFFER, c);
				try {
					let o = e.textures[s], c = o.format, l = o.type;
					if (e.textures.length > 1 && W.readBuffer(W.COLOR_ATTACHMENT0 + s), !K.textureFormatReadable(c)) {
					...
					t >= 0 && t <= e.width - r && n >= 0 && n <= e.height - i && W.readPixels(t, n, r, i, Qe.convert(c), Qe.convert(l), a);
				} finally {
					let e = B === null ? null : J.get(B).__webglFramebuffer;
					q.bindFramebuffer(W.FRAMEBUFFER, e);
				}
			}
			...
			if (e.isWebGLCubeRenderTarget && o !== void 0 && (c = c[o]), c) if (t >= 0 && t <= e.width - r && n >= 0 && n <= e.height - i) {
				...
				if (e.textures.length > 1 && W.readBuffer(W.COLOR_ATTACHMENT0 + s), !K.textureFormatReadable(l)) throw Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");
				...
				let d = W.createBuffer();
				W.bindBuffer(W.PIXEL_PACK_BUFFER, d), W.bufferData(W.PIXEL_PACK_BUFFER, a.byteLength, W.STREAM_READ), W.readPixels(t, n, r, i, Qe.convert(l), Qe.convert(u), 0);
				let f = B === null ? null : J.get(B).__webglFramebuffer;
				q.bindFramebuffer(W.FRAMEBUFFER, f);
				let p = W.fenceSync(W.SYNC_GPU_COMMANDS_COMPLETE, 0);
				return W.flush(), await oe(W, p, 4), W.bindBuffer(W.PIXEL_PACK_BUFFER, d), W.getBufferSubData(W.PIXEL_PACK_BUFFER, 0, a), W.deleteBuffer(d), W.deleteSync(p), a;
			...
			Y.setTexture2D(e, 0), W.copyTexSubImage2D(W.TEXTURE_2D, n, 0, 0, o, s, i, a), q.unbindTexture();
			...
			t.isData3DTexture ? (Y.setTexture3D(t, 0), v = W.TEXTURE_3D) : t.isDataArrayTexture || t.isCompressedArrayTexture ? (Y.setTexture2DArray(t, 0), v = W.TEXTURE_2D_ARRAY) : (Y.setTexture2D(t, 0), v = W.TEXTURE_2D), q.activeTexture(W.TEXTURE0), q.pixelStorei(W.UNPACK_FLIP_Y_WEBGL, t.flipY), q.pixelStorei(W.UNPACK_PREMULTIPLY_ALPHA_WEBGL, t.premultiplyAlpha), q.pixelStorei(W.UNPACK_ALIGNMENT, t.unpackAlignment);
			let y = q.getParameter(W.UNPACK_ROW_LENGTH), b = q.getParameter(W.UNPACK_IMAGE_HEIGHT), x = q.getParameter(W.UNPACK_SKIP_PIXELS), S = q.getParameter(W.UNPACK_SKIP_ROWS), C = q.getParameter(W.UNPACK_SKIP_IMAGES);
			q.pixelStorei(W.UNPACK_ROW_LENGTH, h.width), q.pixelStorei(W.UNPACK_IMAGE_HEIGHT, h.height), q.pixelStorei(W.UNPACK_SKIP_PIXELS, l), q.pixelStorei(W.UNPACK_SKIP_ROWS, u), q.pixelStorei(W.UNPACK_SKIP_IMAGES, d);
			...
			if (e.isDepthTexture) {
				...
				q.bindFramebuffer(W.READ_FRAMEBUFFER, h.__webglFramebuffer), q.bindFramebuffer(W.DRAW_FRAMEBUFFER, g.__webglFramebuffer);
				for (let n = 0; n < c; n++) w && (W.framebufferTextureLayer(W.READ_FRAMEBUFFER, W.COLOR_ATTACHMENT0, J.get(e).__webglTexture, i, d + n), W.framebufferTextureLayer(W.DRAW_FRAMEBUFFER, W.COLOR_ATTACHMENT0, J.get(t).__webglTexture, a, m + n)), W.blitFramebuffer(l, u, o, s, f, p, o, s, W.DEPTH_BUFFER_BIT, W.NEAREST);
				q.bindFramebuffer(W.READ_FRAMEBUFFER, null), q.bindFramebuffer(W.DRAW_FRAMEBUFFER, null);
			} else if (i !== 0 || e.isRenderTargetTexture || J.has(e)) {
				let n = J.get(e), r = J.get(t);
				q.bindFramebuffer(W.READ_FRAMEBUFFER, z), q.bindFramebuffer(W.DRAW_FRAMEBUFFER, ce);
			...
			q.pixelStorei(W.UNPACK_ROW_LENGTH, y), q.pixelStorei(W.UNPACK_IMAGE_HEIGHT, b), q.pixelStorei(W.UNPACK_SKIP_PIXELS, x), q.pixelStorei(W.UNPACK_SKIP_ROWS, S), q.pixelStorei(W.UNPACK_SKIP_IMAGES, C), a === 0 && t.generateMipmaps && W.generateMipmap(v), q.unbindTexture();
			...
			le = 0, ue = 0, B = null, q.reset(), $e.reset();
	...
	dispose() {}
}, cc = new yi(-1, 1, 1, -1, 0, 1), lc = new class extends On {
	constructor() {
		super(), this.setAttribute("position", new gn([
			-1,
			3,
			0,
			-1,
	...
	constructor(e) {
		this._mesh = new Zn(lc, e);
	}
	dispose() {
		this._mesh.geometry.dispose();
	}
	render(e) {
		e.render(this._mesh, cc);
	}
	get material() {
	...
	constructor(e, t = "tDiffuse") {
		super(), this.textureID = t, this.uniforms = null, this.material = null, e instanceof Ir ? (this.uniforms = e.uniforms, this.material = e) : e && (this.uniforms = Nr.clone(e.uniforms), this.material = new Ir({
	...
	constructor(e, t) {
		if (this.renderer = e, this._pixelRatio = e.getPixelRatio(), t === void 0) {
			...
			this._width = n.width, this._height = n.height, t = new qe(this._width * this._pixelRatio, this._height * this._pixelRatio, { type: u }), t.texture.name = "EffectComposer.rt1";
		} else this._width = t.width, this._height = t.height;
		this.renderTarget1 = t, this.renderTarget2 = t.clone(), this.renderTarget2.texture.name = "EffectComposer.rt2", this.writeBuffer = this.renderTarget1, this.readBuffer = this.renderTarget2, this.renderToScreen = !0, this.passes = [], this.copyPass = new dc(oc), this.copyPass.material.blending = 0, this.timer = new Di();
	}
	swapBuffers() {
	...
	render(e) {
		...
		for (let t = 0, r = this.passes.length; t < r; t++) {
			...
			if (r.enabled !== !1) {
				...
				fc !== void 0 && (r instanceof fc ? n = !0 : r instanceof pc && (n = !1));
			}
		}
	...
	constructor() {
		super(), this.isOutputPass = !0, this.uniforms = Nr.clone(hc.uniforms), this.material = new Lr({
			name: hc.name,
			uniforms: this.uniforms,
			vertexShader: hc.vertexShader,
			fragmentShader: hc.fragmentShader
		}), this._fsQuad = new uc(this.material), this._outputColorSpace = null, this._toneMapping = null;
	}
	render(e, t, n) {
	...
	uniforms: {
		...
		smoothWidth: { value: 1 },
		defaultColor: { value: new Z(0) },
		defaultOpacity: { value: 0 }
	},
	vertexShader: "\n\n		varying vec2 vUv;\n\n		void main() {\n\n			vUv = uv;\n\n			gl_Position = projectionMatrix * modelViewMatrix * vec4( position, 1.0 );\n\n		}",
	fragmentShader: "\n\n		uniform sampler2D tDiffuse;\n		uniform vec3 defaultColor;\n		uniform float defaultOpacity;\n		uniform float luminosityThreshold;\n		uniform float smoothWidth;\n\n		varying vec2 vUv;\n\n		void main() {\n\n			vec4 texel = texture2D( tDiffuse, vUv );\n\n			float v = luminance( texel.xyz );\n\n			vec4 outputColor = vec4( defaultColor.rgb, defaultOpacity );\n\n			float alpha = smoothstep( luminosityThreshold, luminosityThreshold + smoothWidth, v );\n\n			gl_FragColor = mix( outputColor, texel, alpha );\n\n		}"
}, yc = class e extends sc {
	constructor(e, t = 1, n, r) {
		super(), this.strength = t, this.radius = n, this.threshold = r, this.resolution = e === void 0 ? new U(256, 256) : new U(e.x, e.y), this.clearColor = new Z(0, 0, 0), this.needsSwap = !1, this.renderTargetsHorizontal = [], this.renderTargetsVertical = [], this.nMips = 5;
		let i = Math.round(this.resolution.x / 2), a = Math.round(this.resolution.y / 2);
		this.renderTargetBright = new qe(i, a, { type: u }), this.renderTargetBright.texture.name = "UnrealBloomPass.bright", this.renderTargetBright.texture.generateMipmaps = !1;
		for (let e = 0; e < this.nMips; e++) {
			let t = new qe(i, a, { type: u });
			t.texture.name = "UnrealBloomPass.h" + e, t.texture.generateMipmaps = !1, this.renderTargetsHorizontal.push(t);
			let n = new qe(i, a, { type: u });
		...
		let o = vc;
		this.highPassUniforms = Nr.clone(o.uniforms), this.highPassUniforms.luminosityThreshold.value = r, this.highPassUniforms.smoothWidth.value = .01, this.materialHighPassFilter = new Ir({
		...
		this.compositeMaterial.uniforms.bloomFactors.value = c, this.bloomTintColors = [
			...
			new G(1, 1, 1),
			new G(1, 1, 1)
		], this.compositeMaterial.uniforms.bloomTintColors.value = this.bloomTintColors, this.copyUniforms = Nr.clone(oc.uniforms), this.blendMaterial = new Ir({
			uniforms: this.copyUniforms,
			vertexShader: oc.vertexShader,
			fragmentShader: oc.fragmentShader,
			premultipliedAlpha: !0,
			blending: 2,
			depthTest: !1,
			depthWrite: !1,
			transparent: !0
		}), this._oldClearColor = new Z(), this._oldClearAlpha = 1, this._basic = new zn(), this._fsQuad = new uc(null);
	}
	dispose() {
...
yc.BlurDirectionX = new U(1, 0), yc.BlurDirectionY = new U(0, 1);
//#endregion
//#region frontend/directions.ts
var bc = [
	{
		id: "aperture",
	...
	camera = new gi(31, 1, .1, 40);
	timer = new Di();
	composer;
	bloomPass;
	coreGlow;
	coreLight = new vi(16722456, 3.5, 7, 2);
	coreMaterial = new Rr({
		color: 16756890,
		emissive: 16722456,
	...
	toolKind = null;
	constructor(e, t) {
		this.container = e, this.eye = t, this.renderer = new ac({
			alpha: !1,
			antialias: !0,
			powerPreference: "high-performance"
		}), this.renderer.domElement.className = "optic-webgl-canvas", this.renderer.outputColorSpace = k, this.renderer.toneMapping = 4, this.renderer.toneMappingExposure = .82, this.renderer.setClearColor(131586, 1), this.renderer.setPixelRatio(Math.min(window.devicePixelRatio || 1, 1.75)), this.container.appendChild(this.renderer.domElement), this.scene.fog = new Mt(131586, .055), this.camera.position.set(0, 0, wc), this.scene.add(this.root), this.timer.connect(document), this.irisMaterial = new Ir({
			uniforms: {
				uTime: { value: 0 },
				uEnergy: { value: 0 },
				uState: { value: 0 },
			...
			depthWrite: !1,
			blending: 2
		}), this.buildScene(), this.composer = new mc(this.renderer), this.composer.addPass(new _c(this.scene, this.camera)), this.bloomPass = new yc(new U(1, 1), .48, .62, .52), this.composer.addPass(this.bloomPass), this.composer.addPass(new gc()), this.resizeObserver = new ResizeObserver(() => this.resize()), this.resizeObserver.observe(this.container), this.stateObserver = new MutationObserver(() => this.syncStateFromDom()), this.stateObserver.observe(this.eye, {
			attributes: !0,
			attributeFilter: ["class"]
		}), this.container.addEventListener("pointermove", this.onPointerMove), this.container.addEventListener("pointerleave", this.onPointerLeave), this.reducedMotionQuery.addEventListener("change", this.onMotionPreferenceChange), this.resize(), this.syncStateFromDom(), this.container.closest(".eye-module")?.classList.add("webgl-ready"), this.frameId = requestAnimationFrame(this.animate);
	}
	setAudioEnergy(e) {
		this.targetAudioEnergy = je.clamp(e, 0, 1);
	}
	setState(e) {
		this.state = e, this.updateStatusLabel(e);
	}
	setToolKind(e) {
		this.toolKind = e, e && (this.targetToolPulse = 1);
	}
	destroy() {
		if (this.destroyed) return;
		this.destroyed = !0, cancelAnimationFrame(this.frameId), this.resizeObserver.disconnect(), this.stateObserver.disconnect(), this.container.removeEventListener("pointermove", this.onPointerMove), this.container.removeEventListener("pointerleave", this.onPointerLeave), this.reducedMotionQuery.removeEventListener("change", this.onMotionPreferenceChange), this.timer.dispose();
		...
		this.composer.dispose(), this.renderer.dispose(), this.renderer.domElement.remove(), this.container.closest(".eye-module")?.classList.remove("webgl-ready");
	}
	buildScene() {
		let e = new Si(2364434, .8), t = new xi(16769226, 2.8);
		t.position.set(-3.5, 4.2, 7);
		let n = new xi(16722456, .65);
		n.position.set(4, -2.5, 4);
		let r = new xi(10660528, 1.1);
		r.position.set(4, -4, 6), this.scene.add(e, t, n, r);
		let i = new Rr({
			color: 723981,
			metalness: .94,
			roughness: .36
		...
		this.addCylinderPlate(2.82, .24, -.58, i), this.addCylinderPlate(2.6, .2, -.42, a), this.addCylinderPlate(2.32, .18, -.27, i);
		let c = [
			[
				2.68,
				.075,
		...
		for (let [e, t, n, r, i] of c) {
			let a = new Zn(new Dr(e, t, 18, 144), r);
			a.position.z = n, this.root.add(a), this.movingRings.push({
				object: a,
				speed: i
			});
		}
		this.addSegmentedRetainer(a, i), this.addCalibrationTicks(o), this.addIndicatorLights();
		let l = new Zn(new Cr(1.66, 128), this.irisMaterial);
		l.position.z = .3, this.root.add(l);
		let u = new Zn(new Er(1.62, 96, 48), this.lensMaterial);
		u.scale.set(1, 1, .31), u.position.z = .52, this.root.add(u);
		let d = new Zn(new Er(.12, 40, 24), this.coreMaterial);
		d.position.z = 1.12, this.root.add(d), this.coreLight.position.set(0, 0, 1.5), this.root.add(this.coreLight);
		let f = new Zn(new Tr(.72, .72), this.coreGlow);
		f.position.z = 1.06, this.root.add(f);
		let p = new zn({
			color: 16772838,
			transparent: !0,
			opacity: .22,
			depthWrite: !1,
			blending: 2
		}), m = new Zn(new Er(.12, 32, 20), p);
		m.scale.set(1.15, .72, .2), m.position.set(-.43, .48, 1.12), this.root.add(m);
		let h = m.clone();
		h.scale.set(.55, .34, .12), h.position.set(-.24, .24, 1.15), this.root.add(h), this.root.rotation.x = -.025, this.root.rotation.y = .035;
	}
	addCylinderPlate(e, t, n, r) {
		let i = new Zn(new wr(e, e, t, 128), r);
		i.rotation.x = Math.PI / 2, i.position.z = n, this.root.add(i);
	}
	addSegmentedRetainer(e, t) {
		let n = new lr(new Sr(.52, .16, .16), e, 12), r = new lr(new Sr(.36, .1, .12), t, 12), i = new Ct();
		for (let e = 0; e < 12; e += 1) {
			let t = e / 12 * Math.PI * 2;
			i.position.set(Math.cos(t) * 2.5, Math.sin(t) * 2.5, -.02), i.rotation.set(0, 0, t + Math.PI / 2), i.updateMatrix(), n.setMatrixAt(e, i.matrix), i.position.set(Math.cos(t) * 2.18, Math.sin(t) * 2.18, .09), i.updateMatrix(), r.setMatrixAt(e, i.matrix);
		}
		n.instanceMatrix.needsUpdate = !0, r.instanceMatrix.needsUpdate = !0, this.root.add(n, r), this.movingRings.push({
			object: n,
			speed: .012
		}), this.movingRings.push({
			object: r,
			speed: -.018
		});
	}
	addCalibrationTicks(e) {
		let t = new lr(new Sr(.025, .14, .025), e, 72), n = new Ct();
		for (let e = 0; e < 72; e += 1) {
			let r = e / 72 * Math.PI * 2, i = e % 6 == 0;
			n.position.set(Math.cos(r) * 2.01, Math.sin(r) * 2.01, .22), n.rotation.set(0, 0, r - Math.PI / 2), n.scale.set(1, i ? 1.7 : .75, 1), n.updateMatrix(), t.setMatrixAt(e, n.matrix);
		}
		t.instanceMatrix.needsUpdate = !0, this.root.add(t), this.movingRings.push({
			object: t,
			speed: .022
		});
	}
	addIndicatorLights() {
		let e = new Er(.055, 24, 16);
		for (let t = 0; t < 6; t += 1) {
			let n = new Rr({
				color: 16722456,
				emissive: 16717320,
				...
				metalness: .15,
				roughness: .25
			}), r = t / 6 * Math.PI * 2 + Math.PI / 6, i = new Zn(e, n);
			i.position.set(Math.cos(r) * 2.36, Math.sin(r) * 2.36, .13), this.ledMaterials.push(n), this.root.add(i);
		}
	}
	resize() {
		let { width: e, height: t } = this.container.getBoundingClientRect();
		e < 2 || t < 2 || (this.camera.aspect = e / t, this.camera.position.z = wc * Math.max(1, .92 / this.camera.aspect), this.camera.updateProjectionMatrix(), this.renderer.setSize(e, t, !1), this.composer.setSize(e, t));
	}
	syncStateFromDom() {
		let e = "idle";
		this.eye.classList.contains("denied") ? e = "denied" : this.eye.classList.contains("listening") ? e = "listening" : this.eye.classList.contains("speaking") ? e = "speaking" : this.eye.classList.contains("thinking") && (e = "thinking"), this.setState(e);
		let t = this.eye.classList.contains("kind-execute") ? "execute" : this.eye.classList.contains("kind-fetch") ? "fetch" : this.eye.classList.contains("kind-search") ? "search" : this.eye.classList.contains("kind-read") ? "read" : null;
		t !== this.toolKind && this.setToolKind(t);
	}
	updateStatusLabel(e) {
		let t = document.getElementById("optic-status-label");
		t && (t.textContent = {
			idle: "Standby",
			listening: "Listening",
			thinking: "Thinking",
	...
	onPointerMove = (e) => {
		...
		this.targetPointer.set(je.clamp((e.clientX - t.left) / t.width * 2 - 1, -1, 1), je.clamp(-((e.clientY - t.top) / t.height * 2 - 1), -1, 1));
	};
	onPointerLeave = () => {
		this.targetPointer.set(0, 0);
	};
	onMotionPreferenceChange = () => {
		this.reducedMotionQuery.matches && (this.targetPointer.set(0, 0), this.pointer.set(0, 0));
	};
	animate = (e) => {
		if (this.destroyed) return;
		this.frameId = requestAnimationFrame(this.animate), this.timer.update(e);
		let t = Math.min(this.timer.getDelta(), .05), n = this.timer.getElapsed(), r = Sc[this.state], i = this.reducedMotionQuery.matches ? 0 : r.motion;
		this.audioEnergy = je.damp(this.audioEnergy, this.targetAudioEnergy, 8, t), this.targetAudioEnergy = je.damp(this.targetAudioEnergy, 0, 2.6, t), this.targetToolPulse = je.damp(this.targetToolPulse, 0, 2.8, t), this.pointer.x = je.damp(this.pointer.x, this.targetPointer.x, 5, t), this.pointer.y = je.damp(this.pointer.y, this.targetPointer.y, 5, t);
		for (let e of this.movingRings) e.object.rotation.z += e.speed * i * t;
		let a = this.reducedMotionQuery.matches ? 0 : Math.sin(n * (this.state === "listening" ? 3.8 : 1.35)) * .012, o = this.audioEnergy * .035, s = 1 + a + o, c = this.root.scale.x, l = je.damp(c, s, 7, t);
		this.root.scale.setScalar(l), this.root.rotation.y = je.damp(this.root.rotation.y, this.pointer.x * .085, 5, t), this.root.rotation.x = je.damp(this.root.rotation.x, -this.pointer.y * .07, 5, t);
		let u = this.state === "thinking" ? 1 : this.state === "speaking" ? .7 : this.state === "listening" ? .55 : .2;
		this.irisMaterial.uniforms.uTime.value = n, this.irisMaterial.uniforms.uEnergy.value = this.audioEnergy, this.irisMaterial.uniforms.uState.value = u, this.irisMaterial.uniforms.uToolPulse.value = this.targetToolPulse;
		let d = Math.max(this.audioEnergy, this.targetToolPulse * .55);
		this.bloomPass.strength = je.damp(this.bloomPass.strength, r.bloom + d * .46, 6, t), this.coreMaterial.emissiveIntensity = je.damp(this.coreMaterial.emissiveIntensity, r.core + d * 3.5, 7, t), this.lensMaterial.emissiveIntensity = je.damp(this.lensMaterial.emissiveIntensity, r.lens + d * .65, 7, t), this.coreLight.intensity = je.damp(this.coreLight.intensity, 7 + r.core * 1.55 + d * 8, 7, t), this.coreGlow.uniforms.uIntensity.value = r.core + d * 2.2;
		let f = this.toolKind ? Cc[this.toolKind] : 16722456;
		this.coreMaterial.emissive.lerp(new Z(f), Math.min(1, t * 4));
		for (let e = 0; e < this.ledMaterials.length; e += 1) {
			let t = this.ledMaterials[e];
			if (!t) continue;
			let i = .5 + .5 * Math.sin(n * 2.2 + e * 1.4);
			t.emissiveIntensity = 1.4 + r.motion * 1.3 + i * (.5 + d);
		}
		this.composer.render();
	};
};
function kc() {
	document.documentElement.dataset.bridgeDirection = xc;
	let e = document.querySelectorAll("[data-direction-id]");
	for (let t of e) {
		let e = t.dataset.directionId, n = bc.find((t) => t.id === e);
		n && (t.textContent = n.shortLabel, t.title = n.ready ? n.label : `${n.label} — in development`, t.disabled = !n.ready, t.setAttribute("aria-pressed", String(n.id === xc)));
	}
}
function Ac() {
	let e = document.getElementById("bridge-cmd"), t = document.getElementById("cmd-input"), n = document.getElementById("cmdline"), r = document.querySelector(".bridge-left"), i = document.getElementById("chess-panel"), a = document.querySelectorAll("[data-bridge-action]");
	for (let i of a) i.addEventListener("click", () => {
		switch (i.dataset.bridgeAction) {
			case "missions":
				r && delete r.dataset.activeSurface;
				let i = window.matchMedia("(min-width: 761px)").matches ? e : t;
				i && (i.value ||= "/mission ", i === t && n?.classList.add("open"), i.focus());
				break;
			case "chess":
				r && (r.dataset.activeSurface = "chess"), document.getElementById("chess-new")?.click();
				break;
			case "viewscreen":
				r && (r.dataset.activeSurface = "viewscreen");
				break;
			case "systems":
	...
	r && i && new MutationObserver(() => {
		i.classList.contains("on") ? r.dataset.activeSurface = "chess" : r.dataset.activeSurface === "chess" && delete r.dataset.activeSurface;
	}).observe(i, {
		attributes: !0,
		attributeFilter: ["class"]
	});
...
function jc() {
	kc(), Ac();
	let e = document.getElementById("optic-stage"), t = document.getElementById("eye");
	if (!(!e || !t)) try {
		window.HALOptic?.destroy();
		let n = new Oc(e, t);
		window.HALOptic = {
			destroy: () => n.destroy(),
			setAudioEnergy: (e) => n.setAudioEnergy(e),
			setState: (e) => n.setState(e),
			setToolKind: (e) => n.setToolKind(e)
		}, window.addEventListener("pagehide", () => window.HALOptic?.destroy(), { once: !0 });
	} catch (e) {
		console.warn("HAL optic renderer unavailable; retaining the CSS fallback.", e);
	}
}
jc();
//#endregion

//# sourceMappingURL=hal-optic.js.map